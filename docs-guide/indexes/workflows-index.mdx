...
| tasks/ retention enforcement | `.github/workflows/tasks-retention.yml` | schedule, workflow_dispatch | tasks/ retention enforcement | blocking by default (subject to branch protection) | workflow logs | docs |
