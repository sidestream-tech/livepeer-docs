...
| Features | Major repo systems, automation surfaces, and functional maps | [feature-map.mdx](./features/feature-map.mdx), [architecture-map.mdx](./features/architecture-map.mdx), [automations.mdx](./features/automations.mdx), [data-integrations.mdx](./features/data-integrations.mdx), [visual-explainer-workflows.mdx](./features/visual-explainer-workflows.mdx) |
| Tooling | CLI and developer tooling support | [lpd-cli.mdx](./tooling/lpd-cli.mdx), [dev-tools.mdx](./tooling/dev-tools.mdx) |
| Frameworks | Structural models, content system conventions, and component governance | [content-system.mdx](./frameworks/content-system.mdx), [component-framework.mdx](./frameworks/component-framework.mdx), [component-governance.mdx](./frameworks/component-governance.mdx) |
...
| Catalog | Generated catalogs plus manual reference indexes and archives | [ai-tools.mdx](./catalog/ai-tools.mdx), [pages-catalog.mdx](./catalog/pages-catalog.mdx), [components-catalog.mdx](./catalog/components-catalog.mdx), [scripts-catalog.mdx](./catalog/scripts-catalog.mdx), [workflows-catalog.mdx](./catalog/workflows-catalog.mdx), [templates-catalog.mdx](./catalog/templates-catalog.mdx), [visual-explainer-workflows-archive.mdx](./catalog/visual-explainer-workflows-archive.mdx) |
