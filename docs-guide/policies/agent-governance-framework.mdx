...
Task 3 implements this layout. Future governance changes must update the runtime files, validators, and this policy together.
...
These files were intentionally retired in Task 3 and should not be recreated as active governance sources:
...
Task 3 implemented the following migration map:
...
| `ASSISTANT.md` | merged into root `AGENTS.md`; no `.mintlify/ASSISTANT.md` adoption in Task 3 |
