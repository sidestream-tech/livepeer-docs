...
Task 3 implements the canonical agent root layout and restores `.allowlist` to a machine-readable root-only file.
...
### Retired invalid or legacy entries removed in Task 3
