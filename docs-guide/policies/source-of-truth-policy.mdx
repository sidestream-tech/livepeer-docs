...
5. `v2/**` contains both publishable docs and governed non-publishable material; `docs.json` plus `docs-guide/policies/v2-folder-governance.mdx` decide which paths are eligible to route.
