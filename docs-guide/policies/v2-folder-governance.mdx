...
The first deliverable for this policy is documentation plus a recommendation-only cleanup matrix. No `v2/` files move until a human reviews the recommendations.
