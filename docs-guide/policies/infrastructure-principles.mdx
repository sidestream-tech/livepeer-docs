...
description: 'Canonical first-principles design for repository infrastructure, quality gates, automation flows, and policy ownership.'
keywords:
  [
    'livepeer',
    'infrastructure',
...
| --- | --- | --- | --- | --- |
| Repository topology | Folder ownership is explicit and immutable. | Root sprawl, misplaced files, v1 mutation | `.githooks/pre-commit`, CI structure checks | `P1` |
...
4. Any new rule must declare layer ownership before implementation.
...
5. Update this document in the same PR when ownership boundaries change.
