...
The workflow is experimental and advisory-first. Use it for factual verification, contradiction review, and claim-family propagation, not generic MDX or link hygiene.
