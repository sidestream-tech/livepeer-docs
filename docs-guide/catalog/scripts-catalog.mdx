...
| `tools/scripts/orchestrator-guides-research-review.js` | Orchestrator guides research review packet generator — reads the live Orchestrators Guides navigation, runs the research skill tranche-by-tranche, and writes reproducible review packets and a master rollup. | `node tools/scripts/orchestrator-guides-research-review.js [flags]` | docs |
