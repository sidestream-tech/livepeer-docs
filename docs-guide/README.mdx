...
> Legacy entrypoint preserved for compatibility. Use [overview.mdx](./overview.mdx) as the canonical landing page.
...
See [source-of-truth-policy.md](./policies/source-of-truth-policy.mdx) for full boundaries.

## Start Here

| If you need to understand...                  | Canonical file                                           |
| --------------------------------------------- | -------------------------------------------------------- |
| Governance and canonical ownership            | [source-of-truth-policy.md](./policies/source-of-truth-policy.mdx) |
| Complete repo capability map                  | [feature-map.md](./features/feature-map.mdx)                       |
| Data + control flow across systems            | [architecture-map.md](./features/architecture-map.mdx)             |
| CLI behavior and operator runbooks            | [lpd.md](./tooling/lpd-cli.mdx)                                       |
| Validation and enforcement gates              | [quality-gates.md](./policies/quality-gates.mdx)                   |
...
| Component layout decisions                    | [component-layout-decisions.mdx](./policies/component-layout-decisions.mdx) |
...
| APIs and external data integrations           | [data-integrations.md](./features/data-integrations.mdx)           |
