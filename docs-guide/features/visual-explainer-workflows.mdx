...
- `v2/gateways/references/technical-architecture.mdx` — Marketplace Interaction Model (commented out)
- `v2/gateways/references/technical-architecture.mdx` — BYOC Container Architecture (commented out)
...
**Where to use it (pilot):** Use internally first in `docs-guide/feature-guides/content-system.mdx` and maintainer handoff docs. Delay homepage "Mission Control" placement until pilot usefulness is validated.
...
| `v2/gateways/references/technical-architecture.mdx` | Contains commented-out BYOC and Marketplace diagrams to rescue |
