...
The governed component library currently exposes **125** named export(s) across five active categories.
...
| [Layout](./layout) | Spatial arrangement containers | 30 |
| [Content](./content) | Content formatting and rendering | 24 |
| [Data](./data) | Data-bound feed renderers | 17 |
| [Page Structure](./page-structure) | Frame-mode and portal scaffolding | 24 |
