 ...
 * @usedIn v2/about/livepeer-network/interfaces.mdx, v2/about/livepeer-network/marketplace.mdx, v2/about/livepeer-network/technical-architecture.mdx, v2/about/livepeer-protocol/technical-architecture.mdx, v2/developers/ai-inference-on-livepeer/overview.mdx, v2/developers/ai-inference-on-livepeer/workload-fit.mdx, v2/developers/ai-pipelines/byoc.mdx, v2/developers/ai-pipelines/workload-fit.mdx, v2/developers/developer-platforms/builder-hub.mdx, v2/gateways-new/guides/explorer.mdx, v2/gateways-new/setup/install/community-projects.mdx, v2/gateways-new/setup/install/install-overview.mdx, v2/gateways-new/setup/run-a-gateway.mdx, v2/gateways/about/quickstart.mdx, v2/gateways/gateway-tools/explorer.mdx, v2/gateways/run-a-gateway/install/community-projects.mdx, v2/gateways/run-a-gateway/install/install-overview.mdx, v2/gateways/run-a-gateway/run-a-gateway.mdx, v2/gateways/using-gateways/gateway-providers.mdx, v2/home/about-livepeer/vision.mdx, v2/home/primer.mdx, v2/orchestrators-new/advanced/hosting-models.mdx, v2/orchestrators/advanced-setup/hosting-models.mdx, v2/solutions/product-hub.mdx
 * @breakingChangeRisk medium
 * @decision KEEP
 * @dataSource none
 * @duplicates none
