...
a low-bitrate test file with no B-Frames and a short GOP length. [Here's a
sample appropriately-formatted Big Buck Bunny file you can use][BBB]. To stream
in to your local box, you can use an `ffmpeg` command such as:
