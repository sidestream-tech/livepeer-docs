...
purpose process outcomes: information, knowledge, intelligence, contextual learning
purpose process terminology: build a case
synonymns: assessment, appraisal, analysis, determination, valuation, study, estimation, measurement
...
Systematic Inquiry: You aren't just guessing; you are using a planned method to analyze your "tags".
Comparison to Standards: You are weighing your gathered facts against your specific goals (e.g., Is this project viable? Is this risk acceptable?).
Action-Oriented Feedback: The result isn't just a "score" but the intelligence needed to decide your next move.
...
DONT: state a problem without providing a solution.
