...
description: >-
  Components for displaying media, visual content, and frame mode elements: video, images, embeds, quotes, carousels,
  diagrams, and social links
audience: everyone
purpose: concept
keywords:
  - livepeer
...
| Prop | Type | Default | Required | Description |
|------|------|---------|----------|-------------|
| `src` | `string` | - | **Yes** | Path to the video file (e.g., "https://raw.githubusercontent.com/livepeer/docs/docs-v2-assets/snippets/assets/media/videos/HeroBackground.mp4") |
...
| `borderColor` | `string` | - | No | Border colour |
...
Social media icon links for Livepeer. Displays a row of social media icon links with official brand colours.
...
| `color` | `string` | - | No | Override colour for all icons |
...
| `titleColor` | `string` | `"var(--hero-text)"` | No | Title colour |
