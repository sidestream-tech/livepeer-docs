...
description: >-
  Basic UI building blocks used throughout the Livepeer documentation: buttons, icons, links, text, dividers,
  containers, tables, and layout utilities
audience: everyone
purpose: concept
keywords:
  - livepeer
...
// BlinkingIcon, BlinkingTerminal, DoubleIconLink commented out - require a legacy theme dependency (components are immutable)
...
import { FlexContainer, GridContainer } from '/snippets/components/layout/layout.jsx'
import { Spacer } from '/snippets/components/primitives/spacer.jsx'
import { StyledTable, TableRow, TableCell } from '/snippets/components/layout/tables.jsx'
import { BorderedBox, CenteredContainer, FullWidthContainer } from '/snippets/components/layout/containers.jsx'
...
{/* DoubleIconLink commented out - requires a legacy theme dependency (component is immutable) */}
{/*
### DoubleIconLink

Link component with icons on both sides. Commonly used for external links like GitHub.

**Note:** Currently unavailable - component depends on legacy theme wiring. See component-bugs.md for details.
*/}
...
{/* BlinkingIcon and BlinkingTerminal commented out - require a legacy theme dependency (components are immutable) */}
{/*
### BlinkingIcon
