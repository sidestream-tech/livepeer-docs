...
A customizable Steps component with colour and styling support. Wraps the standard Steps component with custom CSS styling.
...
| `iconColor` | `string` | `"#18794E"` | No | Background colour for step icons |
| `titleColor` | `string` | theme-aware | No | Colour for step titles |
| `lineColor` | `string` | theme-aware | No | Colour for the connecting line between steps |
