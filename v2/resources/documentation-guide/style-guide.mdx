...
```mdx
{/* ❌ Plain markdown link */}
[Getting Started](/v2/home/get-started)

{/* ✅ Custom component with better styling */}
import { GotoLink } from '/snippets/components/primitives/links.jsx';
<GotoLink label="Getting Started" relativePath="/v2/home/get-started" icon="arrow-right" />
```
...
// import { GotoLink } from '../components/primitives/links.jsx';
```
...
<GotoLink label="Docs" relativePath="/v2/home/get-started" />
// GotoLink can access ThemeData from parent scope
```
...
import ContainersGuide from '/snippets/components/display/containers.mdx'
