...
```jsx
import { H1, H2, PageHeader } from "/snippets/components/page-structure/frame-mode.jsx";
...
- Do not use em dashes in English docs prose. Replace `—` with spaced en dash ` – ` or rewrite the sentence if a comma or colon reads more clearly.
