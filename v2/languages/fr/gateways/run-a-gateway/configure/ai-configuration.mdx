...
sidebarTitle: Configuration AI
description: Configurez les services d'inférence AI sur une passerelle Livepeer
keywords:
  - livepeer
  - gateways
  - run a gateway
...
icon: user-robot
---
{/* codex-i18n:  */}
...
Cette page vous guidera à travers le processus de déploiement et de configuration d'un Livepeer Gateway pour les services d'inférence IA.

## Modes de Gateway

Vous pouvez exécuter un gateway

- **"Hors chaîne"** -> mode dev ou local
- **"Sur chaîne"** -> mode production connecté au réseau Livepeer basé sur la blockchain.
...
## Déployer une passerelle pour les services d'inférence IA

Vous pouvez exécuter le logiciel IA Livepeer en utilisant l'une des méthodes suivantes :

- **Docker** (Recommandé) : La méthode la plus simple et préférée.
- **Binaires prêts à l'emploi**: Une alternative si vous préférez ne pas utiliser Docker.

## <BlinkingIcon size={20} />Déployer une passerelle IA

Suivez les étapes ci-dessous pour lancer votre nœud Livepeer de passerelle IA.
...
## Liens du code de la passerelle

Pour le traitement IA, la passerelle étend ses fonctionnalités pour gérer les workflows spécifiques à l'IA.
...
- **AISessionManager**: Gère les sessions de traitement d'IA et sélectionne les Orchestrators appropriés dotés de capacités d'IA<DoubleIconLink label="ai_http.go" href="https://github.com/livepeer/go-livepeer/blob/5691cb48/server/ai_http.go" iconLeft="github" />
- **Intégration MediaMTX**: Gère la diffusion de médias pour le traitement d'IA
- **Protocole Trickle**: Permet une diffusion efficace pour le traitement vidéo en temps réel d'IA

Le workflow d'IA <DoubleIconLink label="server/ai_process.go" href="https://github.com/livepeer/go-livepeer/blob/5691cb48/server/ai_process.go" iconLeft="github" />implique

- l'authentification des flux d'IA,
- la sélection des Orchestrators capables d'IA,
- le traitement des paiements **en fonction des pixels**, et
- gestion des pipelines d'IA en direct
