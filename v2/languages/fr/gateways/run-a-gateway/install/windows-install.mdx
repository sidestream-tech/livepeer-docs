...
sidebarTitle: Installation sous Windows
description: Comment installer un Livepeer Gateway sous Windows
keywords:
  - livepeer
  - gateways
  - run a gateway
...
icon: windows
---
{/* codex-i18n:  */}
...
Dernière version de go-livepeer : <Badge color="green">{version}</Badge> (récupérée dynamiquement)

Ce guide couvre l'installation du Livepeer Gateway à partir d'une binaire source sur Windows.
...
<Card
  ...
  icon="gear"
  href="/v2/fr/gateways/run-a-gateway/configure/configuration-overview"
  horizontal
  arrow
>
