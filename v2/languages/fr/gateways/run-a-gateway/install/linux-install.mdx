...
sidebarTitle: Installation Linux
description: Comment installer un Livepeer Gateway à partir d'une binaire
keywords:
  - livepeer
  - gateways
  - run a gateway
...
icon: linux
---
{/* codex-i18n:  */}
...
Dernière version de go-livepeer : <Badge color="green">{latestVersion}</Badge> (récupérée dynamiquement)

Ce guide couvre l'installation du Livepeer Gateway à partir d'une binaire sur Linux.
...
Aller à [Configuration](/v2/fr/gateways/run-a-gateway/configure/configuration-overview) pour terminer la configuration du Gateway
