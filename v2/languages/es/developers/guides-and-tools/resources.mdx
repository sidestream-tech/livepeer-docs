...
description: >-
  Una biblioteca curada de herramientas, paneles, lecturas, videos y material de
  referencia de todo el ecosistema Livepeer.
keywords:
  - livepeer
  - developers
  - resources
...
'og:image:height': 630
---
{/* codex-i18n:  */}
import { GotoCard } from '/snippets/components/primitives/links.jsx'

Un conjunto curado de recursos para desarrolladores, operadores de nodos, delegadores y cualquier persona que explore el ecosistema Livepeer. Las secciones cubren herramientas oficiales, paneles analíticos, lecturas de la comunidad, videos y SDKs.

---

## Herramientas y plataformas oficiales

Las herramientas principales mantenidas por Livepeer Inc y la Fundación Livepeer.
...
## SDKs y bibliotecas para desarrolladores

Bibliotecas cliente oficiales y mantenidas por la comunidad.
...
## Paneles de red y analítica

Herramientas para monitorear la red Livepeer y analizar datos on-chain.
...
## Herramientas para operadores de nodos

Herramientas de monitoreo, alertas y operativas para orquestadores y operadores de gateway.
...
## Plataformas y agregadores de la comunidad

Colecciones de recursos e integraciones mantenidas por la comunidad.
...
## Blogs, lecturas y artículos clave

Lecturas esenciales del blog Livepeer y publicaciones de la comunidad.
...
## Seguridad y recompensas por bugs
