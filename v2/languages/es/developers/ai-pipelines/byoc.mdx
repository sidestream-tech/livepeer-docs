...
<Note>
For full BYOC architecture, Gateway/Orchestrator roles, container lifecycle, and Protocol vs AI BYOC concepts, see the [BYOC full guide](/v2/es/developers/ai-pipelines/byoc).
</Note>
...
- [Guía completa de BYOC](/v2/es/developers/ai-pipelines/byoc) - Arquitectura, Gateway/Orchestrator, ciclo de vida del contenedor
