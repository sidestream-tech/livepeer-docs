...
sidebarTitle: Configuración de IA
description: Configurar servicios de inferencia de IA en una puerta de enlace Livepeer
keywords:
  - livepeer
  - gateways
  - run a gateway
...
icon: user-robot
---
{/* codex-i18n:  */}
...
Esta página lo guiará a través del proceso de implementación y configuración de un Livepeer Gateway para servicios de inferencia de IA.

## Modos de Gateway

Puede ejecutar un gateway

- **"Fuera de cadena"** -> modo dev o local
- **"En cadena"** -> modo de producción conectado a la red Livepeer basada en blockchain.
...
## Implementar un Gateway para servicios de inferencia de IA

Puedes ejecutar el software de IA Livepeer utilizando uno de los siguientes métodos:

- **Docker** (Recomendado): El método más sencillo y preferido.
- **Binarios preconstruidos**: Una alternativa si prefieres no usar Docker.

## <BlinkingIcon size={20} />Implementar una puerta de enlace de IA

Siga los pasos a continuación para iniciar su nodo de puerta de enlace de IA Livepeer.
...
## Enlaces de código de la puerta de enlace

Para el procesamiento de IA, la puerta de enlace extiende su funcionalidad para manejar flujos de trabajo específicos de IA.
...
- **AISessionManager**: Gestiona las sesiones de procesamiento de IA y selecciona los Orquestadores adecuados con capacidades de IA<DoubleIconLink label="ai_http.go" href="https://github.com/livepeer/go-livepeer/blob/5691cb48/server/ai_http.go" iconLeft="github" />
- **Integración de MediaMTX**: Maneja la transmisión de medios para el procesamiento de IA
- **Protocolo Trickle**: Permite una transmisión eficiente para el procesamiento en tiempo real de videos de IA

El flujo de trabajo de IA <DoubleIconLink label="server/ai_process.go" href="https://github.com/livepeer/go-livepeer/blob/5691cb48/server/ai_process.go" iconLeft="github" />implica

- autenticar flujos de IA,
- seleccionar Orquestadores capaces de IA,
- procesar pagos **basados en píxeles**, y
- gestionando pipelines de IA en vivo
