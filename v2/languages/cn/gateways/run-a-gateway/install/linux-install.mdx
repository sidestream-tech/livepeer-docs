...
description: 如何从源代码二进制文件安装 Livepeer 网关
keywords:
  - livepeer
  - gateways
  - run a gateway
...
icon: linux
---
{/* codex-i18n:  */}
...
最新 go-livepeer 版本: <Badge color="green">{latestVersion}</Badge> (动态获取)

本指南介绍了如何从源二进制文件在 Linux 上安装 Livepeer 网关。
...
跳转到 [配置](/v2/cn/gateways/run-a-gateway/configure/configuration-overview) 以完成网关的配置
