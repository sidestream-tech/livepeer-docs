...
description: >-
  How to delegate LPT to an orchestrator, earn rewards, and participate in Livepeer network security - a step-by-step
  guide for new delegators.
purpose: concept
keywords:
  - livepeer
  - delegate lpt
...
<Card title="Bridge LPT to Arbitrum" icon="bridge" href="/v2/gateways/run-a-gateway/requirements/on-chain%20setup/bridge-lpt-to-arbitrum" arrow horizontal>
