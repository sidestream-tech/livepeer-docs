...
description: >-
  Run go-livepeer as a transcoding orchestrator: create your wallet, configure
  your node, register, and verify.
keywords:
  - livepeer
  - orchestrators
  - quickstart
...
<CardGroup cols={2}>
 ...
 Full install options and advanced flags.
  ...
  <Card title="Connect to Arbitrum" icon="plug" href="../../setup/connect-to-arbitrum" arrow>
