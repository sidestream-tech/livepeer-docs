---
title: 'Streams API'
description: 'The Livestream API is used to create, retrieve, update, delete stream object from pipeline'
keywords: ["livepeer", "studio", "api", "streams", "livestream"]
...
The Livestream API is used to create, retrieve, update, delete stream objects from the pipeline.
