...
title: 开发者指南
sidebarTitle: 开发者指南
description: 在 Livepeer 上构建用于视频流和 AI 管道的指南
keywords:
  - livepeer
  - developers
...
---
{/* codex-i18n:  */}
## 概览
...
使用 AI 或视频的最简单方法是使用托管服务，例如 Daydream 或 Livepeer Studio。
如果您想直接在协议上开发… 您需要先运行自己的网关节点。
