...
有关挂钩的完整详细信息，请参阅[Git 挂钩文档](/contribute/CONTRIBUTING/GIT-HOOKS.md)。
...
- [Git 钩子文档](/contribute/CONTRIBUTING/GIT-HOOKS.md) - 完整的预提交钩子文档
- [脚本 README](/tools/scripts/snippets/README.mdx) - 详细的脚本文档
- [自动化 README](/snippets/automations/README.mdx) - 自动化概述
- [审计报告](/tasks/reports/_legacy-unmanaged/ungenerated/20-automations-workflows-audit-report.md) - 全面的自动化审计
