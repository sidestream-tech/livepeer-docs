---
title: AI 配置
description: 在 Livepeer 网关上配置 AI 推理服务
sidebarTitle: AI 配置
icon: user-robot
keywords:
  - livepeer
...
---
{/* codex-i18n:  */}
...
- **AISessionManager**: 管理 AI 处理会话并选择具有 AI 能力的适当 Orchestrator<DoubleIconLink label="ai_http.go" href="https://github.com/livepeer/go-livepeer/blob/5691cb48/server/ai_http.go" iconLeft="github" />
- **MediaMTX 集成**: 处理 AI 处理的媒体流
- **Trickle 协议**: 启用高效流式传输以实现实时 AI 视频处理

AI 工作流 <DoubleIconLink label="server/ai_process.go" href="https://github.com/livepeer/go-livepeer/blob/5691cb48/server/ai_process.go" iconLeft="github" /> 涉及
