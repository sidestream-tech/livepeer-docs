---
title: Windows 安装
description: 如何在 Windows 上安装 Livepeer 网关
...
---
{/* codex-i18n:  */}
...
最新 go-livepeer 版本: <Badge color="green">{version}</Badge> (动态获取)

本指南介绍了如何从源二进制文件在 Windows 上安装 Livepeer 网关。
...
<Card
  ...
  icon="gear"
  href="/v2/cn/gateways/run-a-gateway/configure/configuration-overview"
  horizontal
  arrow
>
  Open the Livepeer CLI, then Jump to [Configuration
  Options](/v2/cn/gateways/run-a-gateway/configure/configuration-overview) to finish
