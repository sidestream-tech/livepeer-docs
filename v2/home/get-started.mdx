...
<Columns cols={2}>
    ...
    <DisplayCard icon="building" title="Build a Business">
        ...
        <LinkArrow label="Funding & Opportunities" href="../developers/builder-opportunities/overview" newline={false} description="Find Grants, RFPs & Other Opportunities." />
    </DisplayCard>
...
<Columns cols={2}>
    ...
    <DisplayCard icon="server" title="Earn from Idle GPU">
        <LinkArrow label="Orchestrators" href="/v2/orchestrators/get-started/setup-paths" newline={false} description="Learn more about running an orchestrator." />
    </DisplayCard>
