...
<TabsContainer>
    <Tab title="AI-first" icon="user-robot">
        ...
        - **Machine-Readable Architecture Maps** - docs-guide/feature-guides/feature-map.mdx and docs-guide/feature-guides/architecture-map.mdx provide Mermaid diagrams for AI understanding of system structure.
    ...
    <Tab title="Stakeholder-focused" icon="people-group">
        ...
        - **[Internal docs]** docs-guide/feature-guides/content-system.mdx codifies the IA model, content layers, and copy principles so any future maintainer can understand the stakeholder-driven design rationale.
