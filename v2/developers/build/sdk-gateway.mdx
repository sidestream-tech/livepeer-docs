...
description: 'Build a lightweight Livepeer gateway client in Python, JavaScript, or mobile using the SDK and remote signer — no Go required.'
sidebarTitle: 'SDK / Gateway Client'
keywords: ["livepeer", "gateway", "SDK", "python", "remote signer", "livepeer-python-gateway", "NaaP", "off-chain", "API key"]
pageType: 'guide'
audience: 'developer'
status: 'draft'
---
