...
status: current
---
{/* TODO: Incorporate the 3-path model (Workload Provider / Consumer / Core Contributor)
    from _archive/developer-journey-3path.mdx — specifically the livepeer-ops, Embody pipeline,
    and DeFine/direct smart contract interaction references. */}
