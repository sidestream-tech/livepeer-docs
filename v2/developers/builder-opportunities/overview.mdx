...
description: 'Find grants, programmes, RFPs, treasury proposals, open source contribution pathways, and bug bounties for every type of Livepeer builder.'
keywords: ["livepeer", "developers", "builder opportunities", "grants", "rfps", "open source", "bug bounty", "treasury", "hackathon"]
pageType: "overview"
audience: ["developers", "app-builders", "gateway-operators", "orchestrators", "protocol-contributors"]
status: "current"
