...
description: 'Report smart contract vulnerabilities in the Livepeer protocol and earn USDC rewards through the official Livepeer bug bounty programme on Immunefi.'
keywords: ["livepeer", "bug bounty", "immunefi", "security", "smart contract", "vulnerability", "usdc", "developer", "builder opportunities"]
pageType: "reference"
audience: ["security-researchers", "protocol-contributors", "developers"]
status: "current"
