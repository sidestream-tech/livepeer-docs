...
description: 'What AI inference on Livepeer is, how it works, who it is for, and where to start.'
pageType: overview
keywords: ["livepeer", "ai", "inference", "real-time", "video ai", "orchestrator", "gpu", "overview"]
...
<Columns cols={2}>
  ...
  <GotoCard
    ...
    relativePath="../../orchestrators/get-started/setup-paths"
  />
</Columns>
