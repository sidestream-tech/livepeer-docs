...
If you're new to live video, this page covers the core concepts you need before writing any code. If you already know RTMP, HLS, and how transcoding pipelines work, skip to the [Video Streaming Quickstart](./README).
...
- **First action:** Read **Stream Key vs. Playback ID**, then continue to [Video Streaming Quickstart](./README)
...
<CardGroup cols={2}>
  <Card title="Video Streaming Quickstart" icon="bolt-lightning" href="./README" arrow>
