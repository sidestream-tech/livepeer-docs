...
<BorderedBox variant="accent" padding="16px" style={{ borderLeft: '4px solid var(--green-9)' }}>
 ...
 **[Hardware Specs](#)**
 ...
 <li>Linux (recommended), Windows via WSL2, or Docker (recommended route)</li>
        </ul>
      </div>
      <div style={{ marginBottom: '12px' }}>
 ...
 **This requires that you**
 ...
 <Icon icon="diamond" iconType="solid" size={10} /> AI inference or hardware-accelerated transcoding requires a GPU on the orchestrator
          ...
          <div style={{ marginBottom: '12px' }}>
 <Icon icon="diamond" iconType="solid" size={10} /> See the <DoubleIconLink label="Orchestrator Setup Guide" href="https://docs.livepeer.org/v2/orchestrators/setup/overview" iconLeft="link" />
          </div>
        </BorderedBox>
 ...
 **You will need**
 ...
 <Icon icon="diamond" iconType="solid" size={10} /> **A funded Ethereum account (wallet)**
        ...
        <Card title="Go to On-Chain Setup Guide" icon="chain" href="/v2/gateways/run-a-gateway/requirements/on-chain-setup/on-chain" horizontal arrow>
