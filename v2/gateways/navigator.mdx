...
<StyledSteps iconColor="#2d9a67" titleColor="var(--accent)">
  ...
  <StyledStep title="Guides" icon="book-open">
    **Deep-dive guides for specific topics.**
    ...
    <LinkArrow href="/v2/gateways/guides/setup-options/setup-paths" label="Explore guides →" newline={false} />
  </StyledStep>
...
<AccordionGroup>
  <Accordion title="Setup Paths" icon="route">
    ...
    - <LinkArrow href="/v2/gateways/guides/setup-options/setup-paths" label="Gateway setup paths overview" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/setup-options/setup-paths#on-chain-vs-off-chain-the-key-split" label="On-chain vs off-chain comparison" newline={false} />
