...
<Tabs>
  <Tab title="Build an AI product" icon="wand-magic-sparkles">
    ...
    **Your path:**
    ...
    3. <LinkArrow href="/v2/gateways/guides/job-pipelines/ai-inference" label="AI inference pipelines" newline={false} />  - supported models, request formats, capabilities
    4. <LinkArrow href="/v2/gateways/guides/opportunities/overview" label="Operator opportunities" newline={false} />  - business models for AI gateway operators
  ...
  <Tab title="Transcode video" icon="video">
    ...
    **Your path:**
    ...
    5. <LinkArrow href="/v2/gateways/guides/payments-and-pricing/fund-your-gateway" label="Fund your gateway" newline={false} />  - deposit + reserve on Arbitrum
  ...
  <Tab title="Build a platform" icon="layer-group">
    ...
    **Your path:**
    ...
    2. <LinkArrow href="/v2/gateways/guides/opportunities/naap-multi-tenancy" label="NaaP multi-tenancy guide" newline={false} />  - tenant isolation, auth flows, billing integration
    ...
    4. <LinkArrow href="/v2/gateways/guides/advanced-operations/production-hardening" label="Production hardening" newline={false} />  - scaling, reliability, monitoring
    5. <LinkArrow href="/v2/gateways/guides/opportunities/spe-grant-model" label="SPE grant funding" newline={false} />  - get funded to build
  ...
  <Tab title="Evaluate first" icon="magnifying-glass">
    ...
    **Your path:**
    ...
    4. <LinkArrow href="/v2/gateways/guides/opportunities/community-ecosystem" label="Who's operating today" newline={false} />  - see what others have built
...
## Choose your gateway's payment mode

"On-chain" and "off-chain" describe how your gateway handles **payments** to orchestrators - not where compute happens. All workloads run off-chain on orchestrator hardware.
...
<Note>Running both video and AI workloads from a single node ("dual configuration") is a workload setup choice, not a payment mode. An on-chain gateway supports all workload types. See <LinkArrow href="/v2/gateways/guides/setup-paths/dual-gateway-config" label="Dual gateway configuration" newline={false} /> for details.</Note>
...
flowchart TD
    Q{"How should your gateway<br/>handle payments?"} -->|"Sign tickets locally"| V["On-chain gateway<br/>(holds ETH)"]
...
<StyledSteps iconColor="#2d9a67" titleColor="var(--accent)">
  ...
  <StyledStep title="Guides" icon="book-open">
    **Deep-dive guides for specific topics.**
    ...
    <LinkArrow href="/v2/gateways/guides/setup-paths/gateway-setup-paths" label="Explore guides →" newline={false} />
  </StyledStep>
  ...
  <StyledStep title="Opportunities" icon="rocket">
    **Turn your gateway into a business.**
    ...
    <LinkArrow href="/v2/gateways/guides/opportunities/overview" label="See opportunities →" newline={false} />
  </StyledStep>
  ...
  <StyledStep title="Resources" icon="folder-open">
    **Reference material and community content.**
    ...
    <LinkArrow href="/v2/gateways/guides-and-resources/faq" label="Browse resources →" newline={false} />
  </StyledStep>
</StyledSteps>
...
<AccordionGroup>
  <Accordion title="Setup Paths" icon="route">
    ...
    - <LinkArrow href="/v2/gateways/guides/setup-paths/gateway-setup-paths" label="Gateway setup paths overview" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/setup-paths/on-chain-vs-off-chain" label="On-chain vs off-chain comparison" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/setup-paths/sdk-alt-gateways" label="SDK & alternative gateways" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/setup-paths/dual-gateway-config" label="Dual gateway configuration" newline={false} />
  </Accordion>
  ...
  <Accordion title="AI & Job Pipelines" icon="microchip">
    ...
    - <LinkArrow href="/v2/gateways/guides/job-pipelines/overview" label="Pipeline overview" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/job-pipelines/video-transcoding" label="Video transcoding pipelines" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/job-pipelines/ai-inference" label="AI inference pipelines" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/job-pipelines/byoc-pipelines" label="BYOC custom pipelines" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/job-pipelines/pipeline-configuration" label="Pipeline configuration" newline={false} />
  </Accordion>
  ...
  <Accordion title="Payments & Pricing" icon="credit-card">
    ...
    - <LinkArrow href="/v2/gateways/guides/payments-and-pricing/payment-paths" label="Payment paths" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/payments-and-pricing/fund-your-gateway" label="Fund your gateway" newline={false} />
  ...
  <Accordion title="Monitoring & Tooling" icon="chart-line">
    Health checks, Prometheus/Grafana monitoring, on-chain debugging, available tools and dashboards, and troubleshooting guides.

    - <LinkArrow href="/v2/gateways/guides/monitoring-and-tooling/gateway-health-checks" label="Gateway health checks" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/monitoring-and-tooling/monitoring-setup" label="Monitoring setup" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/monitoring-and-tooling/on-chain-debugging" label="On-chain debugging" newline={false} />
  ...
  <Accordion title="Advanced Operations" icon="gear">
    Production hardening, orchestrator selection strategy, scaling, middleware, and publishing your gateway to the network.

    - <LinkArrow href="/v2/gateways/guides/advanced-operations/production-hardening" label="Production hardening" newline={false} />
    ...
    - <LinkArrow href="/v2/gateways/guides/advanced-operations/publishing" label="Publishing your gateway" newline={false} />
  </Accordion>
  ...
  <Accordion title="Opportunities" icon="rocket">
    ...
    - <LinkArrow href="/v2/gateways/guides/opportunities/overview" label="Operator opportunities overview" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/opportunities/naap-multi-tenancy" label="NaaP multi-tenancy" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/opportunities/spe-grant-model" label="SPE grant model" newline={false} />
    - <LinkArrow href="/v2/gateways/guides/opportunities/community-ecosystem" label="Community & ecosystem" newline={false} />
  </Accordion>
...
|---|---|---|---|
| **AI app developer** | [Quickstart](/v2/gateways/quickstart/gateway-setup) | [AI pipelines](/v2/gateways/guides/job-pipelines/ai-inference) | [Pricing strategy](/v2/gateways/guides/payments-and-pricing/pricing-strategy) |
...
| **Platform builder** | [Business model](/v2/gateways/concepts/business-model) | [NaaP guide](/v2/gateways/guides/opportunities/naap-multi-tenancy) | [Middleware](/v2/gateways/guides/advanced-operations/gateway-middleware) |
| **Evaluating** | [Gateway role](/v2/gateways/concepts/role) | [Capabilities](/v2/gateways/concepts/capabilities) | [Ecosystem](/v2/gateways/guides/opportunities/community-ecosystem) |
| **Existing operator** | [Advanced ops](/v2/gateways/guides/advanced-operations/production-hardening) | [Scaling](/v2/gateways/guides/advanced-operations/scaling) | [Health checks](/v2/gateways/guides/monitoring-and-tooling/gateway-health-checks) |
| **Grant applicant** | [SPE model](/v2/gateways/guides/opportunities/spe-grant-model) | [Opportunities](/v2/gateways/guides/opportunities/overview) | [Community](/v2/gateways/guides/opportunities/community-ecosystem) |
...
<CardGroup cols={3}>
  ...
  <Card title="AI Pipelines" icon="microchip" href="/v2/gateways/guides/job-pipelines/ai-inference" arrow>
    Supported models and request formats.
  </Card>
  <Card title="Payments" icon="credit-card" href="/v2/gateways/guides/payments-and-pricing/payment-paths" arrow>
    How payment flows work.
  </Card>
  <Card title="Ecosystem" icon="users" href="/v2/gateways/guides/opportunities/community-ecosystem" arrow>
