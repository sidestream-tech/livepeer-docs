...
<AccordionGroup>
  ...
  <Accordion title="SPE (Special Purpose Entity)" icon="building">
    An organisation funded by the Livepeer treasury through a governance proposal. SPEs have defined mandates, budgets, and milestone accountability. Several gateway operators (Livepeer Cloud SPE, LLM SPE) are funded through this model.
  </Accordion>
