...
39. **[Monitor and Optimise](https://docs.livepeer.org/gateways/setup/monitor/monitor-and-optimise)** — Key metrics, ETH balance monitoring, ticket redemption rates, log patterns for payment and session failures. Official.
...
43. **[Gateway Operator Opportunities](https://docs.livepeer.org/gateways/guides/opportunities/overview)** — Revenue models: inference fees, SPE grants, Foundation programmes, the NaaP approach to building a gateway business. Official.
