...
<CardGroup cols={2}>
  <Card title="Monitor and Optimise" href="https://docs.livepeer.org/gateways/setup/monitor/monitor-and-optimise" icon="gauge">
...
<CardGroup cols={2}>
  <Card title="Gateway Operator Opportunities" href="https://docs.livepeer.org/gateways/guides/opportunities/overview" icon="briefcase">
