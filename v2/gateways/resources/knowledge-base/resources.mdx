...
<CardGroup cols={2}>
  ...
  <Card title="Web3 Index" href="https://web3index.org" icon="globe">
    Usage-based fee metrics for web3 infrastructure. Livepeer ranks by real demand-side revenue. Useful for benchmarking network growth.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Configuration Flags Reference" href="https://docs.livepeer.org/gateways/references/configuration-flags" icon="flag">
  ...
  <Card title="CLI Commands Reference" href="https://docs.livepeer.org/gateways/references/cli-commands" icon="terminal">
  ...
  <Card title="CLI HTTP API Reference" href="https://docs.livepeer.org/gateways/references/cli-http-api" icon="code">
  ...
  <Card title="Technical Architecture Reference" href="https://docs.livepeer.org/gateways/references/technical-architecture" icon="diagram-project">
    Low-level technical architecture: protocol flows, RPC interfaces, PM ticket structure, segment/capability pricing schemas.
  </Card>
  <Card title="AI API Reference (Gateway Endpoints)" href="https://docs.livepeer.org/gateways/references/ai" icon="robot">
  ...
  <Card title="Contract Addresses Reference" href="https://docs.livepeer.org/gateways/references/contract-addresses" icon="file-contract">
  ...
  <Card title="Arbitrum RPC Reference" href="https://docs.livepeer.org/gateways/references/arbitrum-rpc" icon="plug">
    Recommended Arbitrum RPC endpoints and community-maintained alternatives for gateway on-chain operations.
  </Card>
  <Card title="Orchestrator Offerings Reference" href="https://docs.livepeer.org/gateways/references/orchestrator-offerings" icon="list">
