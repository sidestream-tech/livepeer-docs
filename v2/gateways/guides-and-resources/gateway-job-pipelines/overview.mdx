...
description: 'How gateway operators handle AI job pipelines, capability routing, and BYOC-backed workloads on Livepeer.'
pageType: overview
keywords: ["livepeer", "gateway", "job pipelines", "ai", "byoc", "routing", "capabilities"]
