...
Anyone that wants to build applications and services (like [Daydream](../../developers/developer-platforms/daydream/daydream.mdx) and [Stream.place](../../solutions/streamplace/overview.mdx)) on top of the Livepeer
