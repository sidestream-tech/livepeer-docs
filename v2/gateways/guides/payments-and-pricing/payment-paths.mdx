...
Setting your prices correctly determines which orchestrators your gateway can access and what your compute costs will be. See [Pricing Strategy](/v2/gateways/guides/payments-and-pricing/pricing-strategy) for a practical guide to configuring maximum prices.
