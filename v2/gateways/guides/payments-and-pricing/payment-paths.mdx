...
Not every gateway needs ETH. Not every operator needs to touch a private key. The right payment architecture depends entirely on what kind of gateway you are running and what you are trying to build. This page maps each gateway type to its payment model and helps you decide which path to follow.
...
<Tip>
  For a full explanation of the PM mechanism, including deposit and reserve mechanics, see [How Payments Work](/v2/gateways/concepts/how-payments-work) in the Concepts section.
</Tip>

---

## Payment model by gateway type
...
## The three payment architectures
...
<Tabs>
  <Tab title="Self-managed (on-chain)">
    **You hold the ETH. You manage the key. You sign the tickets.**
    ...
    Next step: [Fund Your Gateway](/v2/gateways/guides/payments/fund-your-gateway)
  </Tab>
  ...
  <Tab title="Remote signer">
    **A separate service holds the key and signs tickets. Your gateway is keyless.**
    ...
    Next step: [Remote Signers](/v2/gateways/guides/payments/remote-signers)
  </Tab>
  ...
  <Tab title="Clearinghouse">
    **A third party manages everything. You get an API key.**
    ...
    Next step: [Payment Clearinghouses](/v2/gateways/guides/payments/payment-clearinghouse-guide)
  </Tab>
</Tabs>
...
Regardless of payment architecture, you still control the **maximum price** your gateway pays orchestrators. This is set via CLI flags or a JSON configuration file and applies per-pipeline for AI workloads and per-pixel for video.

Setting your prices correctly determines which orchestrators your gateway can access and what your compute costs will be. See [Pricing Strategy](/v2/gateways/guides/payments/pricing-strategy) for a practical guide to configuring maximum prices.
...
<CardGroup cols={2}>
  ...
  <Card title="Payment Clearinghouses" icon="building-columns" href="/v2/gateways/guides/payments/payment-clearinghouse-guide">
