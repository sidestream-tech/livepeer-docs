...
<AccordionGroup>
  ...
  <Accordion title="Reserve" icon="vault">
    ...
    {/* REVIEW: Confirm the reserve divisor (100) used in the ticket face value calculation. Rick to verify. */}
...
<Steps>
  ...
  <Step title="Enter deposit and reserve amounts">
    ...
    {/* REVIEW: Confirm recommended deposit/reserve amounts are still accurate. Rick to verify. */}
