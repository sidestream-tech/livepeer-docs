...
<CustomDivider style={{margin: "-1rem 0 -1rem 0"}} middleText="Commercial Products" />
...
<CustomDivider style={{margin: "-1rem 0 -1rem 0"}} middleText="Infrastructure & Tooling" />
...
<CustomDivider style={{margin: "-1rem 0 -1rem 0"}} middleText="Foundation Programmes" />
...
<CustomDivider style={{margin: "-1rem 0 -1rem 0"}} middleText="Community" />
