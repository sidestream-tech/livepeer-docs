...
<Tabs>
    <Tab title="Livepeer Explorer" icon="gauge-high">
        <BorderedBox variant="accent">
            ...
            Status: <Badge color="red"> In Development </Badge>

            <LinkArrow label="Experimental Gateway Explorer" href="https://explorer-arbitrum-one-git-feat-add-g-10dba1-livepeer-foundation.vercel.app/" />

            <iframe src="https://explorer-arbitrum-one-git-feat-add-g-10dba1-livepeer-foundation.vercel.app/gateways" height="600px" width="100%" style={{marginTop: "1rem"}} />
    ...
    <Tab title="Cloud SPE Tools" icon="gauge-high">
        <BorderedBox variant="accent">
            ...
            <iframe src="https://tools.livepeer.cloud/gateways" height="600px" width="100%"/>
            <br/>
            <GotoCard
    ...
    <Tab title="On-Chain" icon="link">
        <BorderedBox variant="accent">
            ...
            - All Contract Adresses <LinkArrow href="../../resources/technical/contract-addresses.mdx" label="Livepeer Contract Addresses" />

            <br/>
            For detailed on-chain debugging workflows, see <LinkArrow href="/v2/gateways/guides/monitoring-and-tooling/on-chain-debugging" label="On-Chain Debugging" newline={false} />.
