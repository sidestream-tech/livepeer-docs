...
<Tabs>
  ...
  <Tab title="AI Video Startup Programme" icon="rocket">
    ...
    {/* REVIEW: Confirm current programme name, application process, cohort timing, and URL with Foundation BD team. */}
  ...
  <Tab title="Community Signer" icon="shield-check">
    ...
    {/* REVIEW: Confirm signer.eliteencoder.net is still operational and free. */}
...
<AccordionGroup>
  ...
  <Accordion title="Livepeer Tools" icon="gauge-high">
    ...
    {/* REVIEW: Confirm whether tools.livepeer.cloud lists gateways and how to request a listing. */}
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Gateway Showcase" icon="globe" href="/v2/gateways/guides/roadmap-and-funding/gateway-showcase">
    Real projects and tools built on Livepeer Gateways.
  </Card>
  <Card title="Business Case" icon="chart-line" href="/v2/gateways/guides/operator-considerations/business-case">
