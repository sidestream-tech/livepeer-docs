...
<BorderedBox variant="accent">
    <Tabs>
        ...
        <Tab title="AI" icon="user-robot">
            ...
            <Note>
            For AI routing architecture and orchestrator discovery, see <LinkArrow href="./ai-pipelines" label="AI Pipelines" newline={false} />. This section covers the tuning parameters you adjust after your AI gateway is running.
            </Note>
            ...
            **Warm vs cold models:**
            ...
            {/* REVIEW: confirm whether warm-per-GPU limit has changed since beta. */}
