...
Your middleware layer (see [Gateway Middleware](/gateways/guides/advanced-ops/gateway-middleware)) routes incoming requests to the correct gateway instance based on the customer's tier.
...
<CardGroup cols={2}>
  <Card title="Production Hardening" icon="arrow-left" href="/gateways/guides/advanced-ops/production-hardening">
    Security, TLS, and HA — covered before this guide.
  </Card>
  <Card title="Scaling & Resource Management" icon="arrow-right" href="/gateways/guides/advanced-ops/scaling">
    Session limits and when to scale horizontally.
  </Card>
  <Card title="Orchestrator Offerings Reference" icon="book" href="/gateways/references/orchestrator-offerings">
    Full OrchestratorInfo data structure and discovery API reference.
  </Card>
  <Card title="Configuration Flags" icon="sliders" href="/gateways/references/configuration-flags">
