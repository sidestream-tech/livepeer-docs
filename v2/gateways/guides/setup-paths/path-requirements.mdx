---
title: 'Gateway Requirements by Path'
sidebarTitle: 'Requirements by Path'
...
This page lists the prerequisites for each gateway path in full. Use the tabs to jump to your chosen path.

If you have not yet chosen a path, start with [Choose Your Gateway Path](/v2/gateways/guides/setup-paths/gateway-setup-paths).
...
<Tabs>
  ...
  <Tab title="AI Gateway (off-chain)" icon="robot">
    ...
    <StyledSteps iconColor="#18794e" titleColor="#fff" lineColor="#18794e" iconSize="24px">
      ...
      <StyledStep title="Remote signer endpoint" icon="key">
        ...
        **Community-hosted option (free):**
        ...
        <Card title="Remote signers — full documentation" icon="key" href="/v2/gateways/advanced/remote-signers" arrow horizontal>
    ...
    <Card title="AI gateway quickstart" icon="bolt" href="/v2/gateways/get-started/ai-gateway-quickstart" arrow horizontal>
  ...
  <Tab title="Video Gateway (on-chain)" icon="video">
    ...
    <StyledSteps iconColor="#18794e" titleColor="#fff" lineColor="#18794e" iconSize="24px">
      ...
      <StyledStep title="ETH on Arbitrum One" icon="ethereum">
        ...
        <Accordion title="Step-by-step: get ETH onto Arbitrum" icon="ethereum">
          ...
          <Card title="Full fund gateway guide" icon="ethereum" href="/v2/gateways/setup/requirements/on-chain/fund-gateway" arrow horizontal>
    ...
    **FFmpeg:**
    ...
    <Card title="Video gateway setup" icon="play" href="/v2/gateways/get-started/gateway-setup" arrow horizontal>
  ...
  <Tab title="SDK / Alternative" id="sdk-alternative" icon="code">
    ...
    **Option B: Run your own remote signer**
    ...
    <Card title="Remote signers — full protocol documentation" icon="key" href="/v2/gateways/advanced/remote-signers" arrow horizontal>
...
<CardGroup cols={3}>
  ...
  <Card title="Fund your gateway" icon="ethereum" href="/v2/gateways/setup/requirements/on-chain/fund-gateway" arrow>
