...
<Tabs>
  ...
  <Tab title="Off-chain gateway">
    ...
    See the <LinkArrow href="/v2/gateways/payments/remote-signers" label="Remote Signers" newline={false} /> page for how discovery works in off-chain operational mode.
  </Tab>
</Tabs>
