...
<CenteredContainer style={{ width: '90%' }}>
  <Tip>Gateways do not earn at the protocol level - they earn at the business layer. The protocol controls what you pay orchestrators; you control what you charge customers. The difference is your margin.</Tip>
</CenteredContainer>

---

This page explains how gateway economics work. For what gateways *do*, see [Capabilities](/v2/gateways/concepts/capabilities). For the internal payment system, see [How Payments Work](/v2/gateways/payments/how-payments-work).

<CustomDivider middleText="Payment Flow" />

## How money moves through the network
...
## If gateways don't earn protocol rewards, why run one?
