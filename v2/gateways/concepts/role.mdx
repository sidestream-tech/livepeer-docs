...
<CustomDivider middleText="Role Evolution" spacing="tight" />
...
<CenteredContainer preset="wide900" marginBottom="-1rem" textAlign="center">
...
<CustomDivider middleText="Role Functions" spacing="tight" />
