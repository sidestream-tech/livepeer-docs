...
<CenteredContainer style={{ width: '90%' }}>
  <Tip>Gateways are the the essential layer for Application Devlopers. They are the demand side of the Livepeer network. Anyone building applications on Livepeer - video streaming, AI inference, real-time AI video - connects through a gateway.</Tip>
</CenteredContainer>
