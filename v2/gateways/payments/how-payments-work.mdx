...
description: >-
  Understand Livepeer's probabilistic micropayment system and what it means for gateway operators managing payment
  signing keys, ETH balances, and on-chain settlement.
purpose: concept
pageType: concept
audience:
  - gateway-operator
