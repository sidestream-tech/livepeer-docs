...
description: "Understand Livepeer's probabilistic micropayment system and what it means for gateway operators managing payment signing keys, ETH balances, and on-chain settlement."
pageType: concept
...
**Security concern:** A compromised gateway process could expose your signing key and drain your ETH deposit. For production deployments, consider using a [Remote Signer](/v2/gateways/run-a-gateway/remote-signers) to isolate signing from media handling.
</Callout>
