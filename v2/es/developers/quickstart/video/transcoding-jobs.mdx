...
- [Crear referencia del endpoint de trabajo de transcodificación](/platforms/livepeer-studio/api-reference/transcode/create)
- [Resumen de la API de transcodificación](/platforms/livepeer-studio/api-reference/transcode/overview)
- [Resumen de la API de tareas](/platforms/livepeer-studio/api-reference/tasks/overview)
- [Referencia del endpoint Obtener Tarea](/platforms/livepeer-studio/api-reference/tasks/get)
- [Resumen de la API de Studio](/platforms/livepeer-studio/reference/api)
- [Resumen de los SDKs](/platforms/livepeer-studio/reference/sdks)
...
- Referencias de docs locales del repositorio (no validadas hasta ser verificadas cruzadamente): `/platforms/livepeer-studio/api-reference/transcode/create`, `/platforms/livepeer-studio/api-reference/tasks/get`
