...
description: Cómo instalar una puerta de enlace Livepeer desde un binario fuente
sidebarTitle: Instalación en Linux
icon: linux
keywords:
  - livepeer
  - gateways
...
---
{/* codex-i18n:  */}
...
Última versión de go-livepeer: <Badge color="green">{latestVersion}</Badge> (obtenida dinámicamente)

Este tutorial cubre la instalación del Livepeer Gateway desde un binario en Linux.
...
Saltar a [Configuración](/v2/es/gateways/run-a-gateway/configure/configuration-overview) para finalizar la configuración del Gateway
