...
description: Cómo instalar una puerta de enlace Livepeer usando Windows
sidebarTitle: Instalación en Windows
icon: windows
keywords:
  - livepeer
  - gateways
...
---
{/* codex-i18n:  */}
...
Última versión de go-livepeer: <Badge color="green">{version}</Badge> (obtenida dinámicamente)

Este guía cubre la instalación del Livepeer Gateway desde el binario fuente en Windows.
...
<Card
  ...
  icon="gear"
  href="/v2/es/gateways/run-a-gateway/configure/configuration-overview"
  horizontal
  arrow
>
  Open the Livepeer CLI, then Jump to [Configuration
  Options](/v2/es/gateways/run-a-gateway/configure/configuration-overview) to finish
