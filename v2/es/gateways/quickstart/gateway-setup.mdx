...
It uses defaults for all optional parameters. See the [full setup guide](/v2/es/gateways/run-a-gateway/run-a-gateway) for more details on customising your Gateway. \*/}
