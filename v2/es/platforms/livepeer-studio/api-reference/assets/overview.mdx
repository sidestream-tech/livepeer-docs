...
description: >-
  La API de Activos se utiliza para crear, recuperar, actualizar y eliminar
  objetos de activos desde la tubería
keywords:
  - livepeer
  - studio
  - api
...
---
{/* codex-i18n:  */}
# API de Activos

La API de Activos se utiliza para crear, recuperar, actualizar y eliminar objetos de activos desde la tubería.
...
- [Subir Activo](./upload) - `POST /asset/request-upload`
- [Subir activo mediante URL](./upload-via-url) - `POST /asset/request-upload/url`
- [Obtener activo](./get) - `GET /asset/{assetId}`
- [Obtener todos los activos](./get-all) - `GET /asset`
- [Actualizar activo](./update) - `PATCH /asset/{assetId}`
- [Eliminar activo](./delete) - `DELETE /asset/{assetId}`
