---
title: API de transmisiones
description: >-
  La API de transmisión en vivo se utiliza para crear, recuperar, actualizar y
  eliminar objetos de transmisión desde la tubería
keywords:
  - livepeer
  - studio
  - api
...
---
{/* codex-i18n:  */}
# API de transmisiones

La API de transmisión en vivo se utiliza para crear, recuperar, actualizar y eliminar objetos de transmisión desde la tubería.
...
- [Crear transmisión](./create) - `POST /stream`
- [Obtener transmisión](./get) - `GET /stream/{id}`
- [Obtener todas las transmisiones](./get-all) - `GET /stream`
- [Actualizar transmisión](./update) - `PATCH /stream/{id}`
- [Eliminar transmisión](./delete) - `DELETE /stream/{id}`
- [Finalizar transmisión](./terminate) - `POST /stream/{id}/terminate`
- [Crear clip](./create-clip) - `POST /stream/{id}/clip`
- [Obtener Clip](./get-clip) - `GET /stream/{id}/clip/{clipId}`
- [Agregar objetivo de multistream](./add-multistream-target) - `POST /stream/{id}/multistream/target`
- [Eliminar objetivo de multistream](./delete-multistream-target) - `DELETE /stream/{id}/multistream/target/{targetId}`
