---
title: Livepeer Aperçu du Marketplace
description: >-
  Cette page fournit un aperçu du Livepeer Marketplace, y compris les offres que
  les Orchestrateurs publient, afin de fournir aux opérateurs de passerelle le
  contexte dont ils ont besoin pour découvrir et acheminer les requêtes
  d'application.
...
---
{/* codex-i18n:  */}
...
Le Livepeer Marketplace permet **_Orchestrateurs_** d'annoncer les services de calcul disponibles,
services de calcul (IA & Vidéo), les prix et les caractéristiques de performance.

Le Marketplace est **NON** un marché public pour les utilisateurs finaux, plutôt, c'est une interface programmatique
pour que les Gateways découvrent et connectent des applications aux services disponibles.

Dans le Livepeer Marketplace, **Les passerelles agissent comme un moteur de recherche**

Ils découvrent les offres des orchestrateurs, appliquent la logique de sélection et de routage, et assurent l'accès aux services appropriés
pour les applications en fonction des coûts, des performances et des exigences de politique.

<br />
> - **Orchestrateurs** publish services to the Livepeer Marketplace; > - **Passerelles**
filtrer et connecter les requêtes d'application à ces services.
<br />
<br />
...
## Détails de l'offre d'orchestrateur

Une offre est une déclaration structurée de :

- Modèles pris en charge (par ex., SDXL, ControlNet, modèles de profondeur)
- Pipelines pris en charge (ComfyStream, Daydream, BYOC)
- Tarification par image / par seconde / par requête
- Niveaux GPU et métriques de performance
- Disponibilité régionale
- Accords de niveau de service (SLA) et latence attendue

Les orchestrateurs publient leurs offres via le `OrchestratorInfo` structure de données
...
Les orchestrateurs publient des offres de niveau calcul sur le Marketplace afin que les Gateways puissent les découvrir et acheminer les tâches vers.
