...
<Columns cols={3}>
    ...
    <div>
        Related Pages
        - [Run a Gateway](/v2/fr/gateways/quickstart/gateway-setup)
        - [Fund Gateway](./fund-gateway)
        - [Install Gateway](/v2/fr/gateways/run-a-gateway/install/install-overview)
        - [RPC Reference](/v2/fr/gateways/references/arbitrum-rpc)
    </div>
...
<Card
  ...
  href="/v2/fr/gateways/run-a-gateway/install/install-overview"
  icon="tools"
  horizontal
  arrow
>
  ...
  -> then come back to this guide.{' '}
    ...
    Livepeer créera automatiquement un nouveau portefeuille et un keystore pour vous si vous ne fournissez pas d'adresse de portefeuille existante après la première[installation de votre logiciel Gateway](/v2/fr/gateways/run-a-gateway/install/install-overview).
...
<StyledStep title="RPC URL `-ethUrl` flag" titleSize="h2">
    ...
    <Accordion title="See All RPC Options" icon="link">
        <Tabs>
            ...
            - Dynamically Imported: <DoubleIconLink label="Arbitrum RPC Reference" href="/v2/fr/gateways/references/arbitrum-rpc" iconLeft="books" />
...
<StyledStep title="ETH Keystore `-ethKeystorePath`" titleSize="h2">
    ...
    <Tip>
        It's recommended to let Livepeer devtools automatically create the keystore on first run after [installing the Gateway software](/v2/fr/gateways/run-a-gateway/install/install-overview).
    </Tip>
