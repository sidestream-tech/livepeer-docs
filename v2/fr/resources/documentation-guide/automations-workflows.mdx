...
Pour plus de détails sur les hooks, voir le [Documentation des Git Hooks](/contribute/CONTRIBUTING/GIT-HOOKS.md).
...
- [Documentation des hooks Git](/contribute/CONTRIBUTING/GIT-HOOKS.md) - Documentation complète des hooks de pré-validation
...
- [Rapport d'audit](/tasks/reports/_legacy-unmanaged/ungenerated/20-automations-workflows-audit-report.md) - Audit complet des automatisations
