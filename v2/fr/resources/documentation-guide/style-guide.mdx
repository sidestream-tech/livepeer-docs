...
Pour plus de détails sur les hooks, consultez le [Documentation des Git Hooks](/contribute/CONTRIBUTING/GIT-HOOKS.md).
...
- [Documentation des hooks Git](/contribute/CONTRIBUTING/GIT-HOOKS.md) - Compléter la documentation du hook pre-commit
