...
- [Référence de l'endpoint Créer un travail de transcodage](/platforms/livepeer-studio/api-reference/transcode/create)
- [Aperçu de l'API de transcodage](/platforms/livepeer-studio/api-reference/transcode/overview)
- [Aperçu de l'API des tâches](/platforms/livepeer-studio/api-reference/tasks/overview)
- [Référence de l'endpoint Get Task](/platforms/livepeer-studio/api-reference/tasks/get)
- [Aperçu de l'API Studio](/platforms/livepeer-studio/reference/api)
- [Aperçu des SDK](/platforms/livepeer-studio/reference/sdks)
...
- Références de docs locales (non validées jusqu'à vérification croisée) : `/platforms/livepeer-studio/api-reference/transcode/create`, `/platforms/livepeer-studio/api-reference/tasks/get`
