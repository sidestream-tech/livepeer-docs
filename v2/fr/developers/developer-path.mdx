...
<Steps>
  ...
  <Step title="Engineer your BYOC containers" icon="docker">
    ...
    <Card title="BYOC Documentation" icon="boxes" href="/v2/fr/developers/ai-pipelines/byoc" arrow horizontal>
  ...
  <Step title="Deploy workloads through your gateway" icon="arrow-up-right-from-square">
    ...
    <Card title="AI Pipelines Overview" icon="brain-circuit" href="/v2/fr/developers/ai-pipelines/overview" arrow horizontal>
...
<Columns cols={2}>
  ...
  <Card title="Contribution Guide" icon="book-open" href="/v2/fr/developers/guides-and-resources/contribution-guide" arrow>
