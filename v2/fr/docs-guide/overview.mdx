...
| Carte complète des capacités du dépôt                  | [feature-map.md](./features/feature-map.mdx)                       |
| Flux de données et de contrôle entre les systèmes            | [architecture-map.md](./features/architecture-map.mdx)             |
| Comportement de la CLI et des manuels d'opérateur            | [lpd.md](./tooling/lpd-cli.mdx)                                       |
| Portes de validation et d'application              | [quality-gates.md](./policies/quality-gates.mdx)                   |
| Actions GitHub, n8n et pipelines d'automatisation | [automation-pipelines.md](./features/automations.mdx)     |
| Architecture de l'information et stratégie de contenu | [content-system.md](./feature-guides/content-system.mdx)                 |
| APIs et intégrations de données externes           | [data-integrations.md](./features/data-integrations.mdx)           |
| Catalogue de l'arborescence des pages (généré)                | [pages-index.mdx](./indexes/pages-index.mdx)                     |
| Catalogue des composants (généré)                | [components-index.mdx](./indexes/components-index.mdx)           |
| Catalogue des scripts (généré)                    | [scripts-index.md](./scripts-index.md)                   |
| Catalogue des workflows (généré)                  | [workflows-index.mdx](./indexes/workflows-index.mdx)             |
| Catalogue des modèles de problème/PR (généré)         | [templates-index.mdx](./indexes/templates-index.mdx)             |
