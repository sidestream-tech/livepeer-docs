...
Start go-livepeer with `-enableAI` and set your Arbitrum RPC and other flags. Configure **aiModels.json** to declare pipelines and models (see [Configure your orchestrator](/v2/orchestrators/get-started/quickstart)). Set per-model or per-pipeline pricing so gateways can route to you.
