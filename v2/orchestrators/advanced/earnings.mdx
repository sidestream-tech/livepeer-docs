...
description: >-
  How orchestrators earn ETH fees and LPT rewards on Livepeer - fee types, reward calculation, commission parameters,
  and what affects your income.
purpose: concept
keywords:
  - livepeer
...
<CardGroup cols={2}>
 ...
 Why LPT exists and how it functions in the protocol.
  ...
  <Card title="Setting Up an Orchestrator" icon="server" href="/v2/orchestrators/setup/setup-guide" arrow>
