...
If you're new to Livepeer and just want to contribute a GPU without running a full orchestrator, consider [joining an existing pool](/v2/orchestrators/guides/join-a-pool) instead. The [Orchestrator Quickstart](/v2/orchestrators/quickstart/dep-x-setup-paths) has a decision tree to help you choose.
