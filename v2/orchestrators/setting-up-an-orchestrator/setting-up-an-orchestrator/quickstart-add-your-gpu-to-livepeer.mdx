...
After [installing go-livepeer](../../setup/install-go-livepeer), configure the node so gateways can discover you and send work. This page covers core flags and optional config files.

## Core configuration

### Network and wallet

- **-ethUrl** - Arbitrum RPC URL. See [Connect to Arbitrum](../../setup/install-go-livepeer).
