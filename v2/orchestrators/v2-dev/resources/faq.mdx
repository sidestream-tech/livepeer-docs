...
sidebarTitle: FAQ
description: >-
  Answers to common orchestrator questions and step-by-step fixes for the most
  frequent errors — installation, networking, job routing, AI pipelines, and
  earnings.
keywords:
  - livepeer
  - orchestrator
...
{/*
REVIEW: The following topics were in the previous version and are not in this draft. Human to decide whether to include:
