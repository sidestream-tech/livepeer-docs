...
NVIDIA GPUs only. AMD and Apple Silicon are not supported by go-livepeer's AI runner. See [Hardware Requirements](/v2/orchestrators/guides/feasibility-and-hardware/hardware) for the full spec list.
</Accordion>
...
| **Start here** | → [Join a Pool](/v2/orchestrators/guides/setup-paths/join-a-pool) | → [Setup Guide](/v2/orchestrators/setup/guide) | → [Siphon Setup](/v2/orchestrators/guides/setup-paths/siphon-setup) | → Contact us |
...
<Steps>
  <Step title="Hardware and feasibility">
    ...
    [Hardware Requirements](/v2/orchestrators/guides/feasibility-and-hardware/hardware) · [Feasibility and Economics](/v2/orchestrators/guides/feasibility-and-hardware/feasibility-economics)
  </Step>
...
|---|---|---|
| A home miner with 1–2 GPUs and no LPT | [Join a Pool](/v2/orchestrators/guides/setup-paths/join-a-pool) | [Feasibility](/v2/orchestrators/guides/feasibility-and-hardware/feasibility-economics) (when considering solo) |
| A solo operator wanting full control | [Setup Guide](/v2/orchestrators/setup/guide) | [Session Limits](/v2/orchestrators/guides/feasibility-and-hardware/session-limits) → [Pricing Setup](/v2/orchestrators/setup/r-configure) |
| An operator wanting key security + reward safety | [Siphon Setup](/v2/orchestrators/guides/setup-paths/siphon-setup) | [Setup Guide](/v2/orchestrators/setup/guide) (GPU machine) |
...
| Evaluating whether it's worth it at all | [Feasibility and Economics](/v2/orchestrators/guides/feasibility-and-hardware/feasibility-economics) | [Benchmarking](/v2/orchestrators/guides/feasibility-and-hardware/benchmarking) |
...
<CardGroup cols={2}>
  ...
  <Card title="Hardware Requirements" icon="microchip" href="/v2/orchestrators/guides/feasibility-and-hardware/hardware">
