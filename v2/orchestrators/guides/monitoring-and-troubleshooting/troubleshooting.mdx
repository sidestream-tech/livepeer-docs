...
See [Session Limits](/v2/orchestrators/guides/feasibility/session-limits) for the full calculation methodology.
</Accordion>
...
See [Model VRAM Reference](/v2/orchestrators/guides/feasibility/hardware#ai-vram-requirements) for per-pipeline minimums.
</Accordion>
...
| NVIDIA Container Toolkit missing | `docker run --gpus all nvidia/cuda:11.0-base nvidia-smi` fails | Install `nvidia-container-toolkit` — see [Hardware Reference](/v2/orchestrators/guides/feasibility/hardware#nvidia-container-toolkit) |
