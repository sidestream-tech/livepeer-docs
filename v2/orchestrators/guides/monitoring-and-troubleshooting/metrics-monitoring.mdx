...
<CardGroup cols={2}>
  ...
  <Card title="AI Configuration" icon="robot" href="/v2/orchestrators/setup/ai-configuration">
    Setting up aiModels.json and the AI runner container.
  </Card>
  <Card title="Session Limits" icon="gauge" href="/v2/orchestrators/guides/feasibility/session-limits">
