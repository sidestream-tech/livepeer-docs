...
<StyledTable variant="bordered">
  <TableRow header>
    ...
    <TableCell header>Real-time AI (Cascade)</TableCell>
  </TableRow>
  <TableRow>
...
These changes are required because the pipeline registry is not fully dynamic yet. See the full custom pipeline development guide in the [ai-runner.md](https://github.com/livepeer/ai-runner) documentation.
...
<Accordion  title="Pipeline not receiving real-time jobs" icon="microchip">
...
<Accordion  title="Custom pipeline not receiving jobs after registration" icon="triangle-exclamation">
...
<CardGroup cols={2}>
  ...
  <Card title="Model Hosting and VRAM" icon="microchip" href="/v2/orchestrators/guides/workloads-and-ai/model-vram-reference">
  ...
  <Card title="AI Workloads Overview" icon="diagram-project" href="/v2/orchestrators/guides/workloads-and-ai/ai-workloads-guide">
...
{/*
  PURPOSE:
  Journey step: "Set up realtime AI video processing"
  Guide for configuring live video-to-video AI pipelines (realtime inference
  on video streams, e.g. style transfer, object detection overlays).

  CONTENT SHOULD INCLUDE:
  - What realtime AI is vs batch (latency requirements, session model)
  - Prerequisites: GPU with sufficient VRAM, low-latency network
  - Configuration for live AI pipelines
  - Model selection for realtime (must be fast: Lightning, LCM)
  - -livePaymentInterval configuration
  - Testing with live video streams
  ...
  JOURNEY POSITION:
  1-4. Previous pages...
  5. Realtime AI Setup (this page) - "Set up realtime AI"
  6. Model VRAM Reference - "Which models fit my GPU?"

  CROSS-REFS:
  - Batch AI Setup (this section) - non-realtime alternative
  - AI Workloads Guide (this section) - conceptual overview
  - Gateway Tab > Node Pipelines > AI Pipelines - gateway routing for live AI
  - Payments & Pricing - live AI payment intervals
*/}
