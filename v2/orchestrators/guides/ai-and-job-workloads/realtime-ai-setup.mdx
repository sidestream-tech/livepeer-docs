...
{/*
  ...
  PLAN TARGET: realtime-ai-setup (keep)
  SECTION: Workloads & AI → "What jobs do I run?"
  JOB STORIES: J2 (realtime AI workload)

  CROSS-REFS:
  - Workloads & AI > AI Inference Operations - AI architecture concepts
  - Config & Optimisation > Capacity Planning - realtime VRAM requirements
  - Tutorials > Realtime AI Tutorial - end-to-end walkthrough
*/}
