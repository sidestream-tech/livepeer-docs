...
<Accordion  title="Derive maxSessions from benchmarks, not guesses" icon="triangle-exclamation">
...
<Accordion  title="Monitor Real-Time Duration Ratio in production" icon="gear">
...
<CardGroup cols={2}>
  ...
  <Card title="Job Types Overview" icon="list" href="/v2/orchestrators/guides/workloads-and-ai/job-types">
...
{/*
  PURPOSE:
  Journey step: "How does video transcoding work on my orchestrator?"
  Guide covering video transcoding workloads from the orchestrator perspective:
  how segments arrive, processing, and output.

  CONTENT SHOULD INCLUDE:
  - Segment-based transcoding pipeline
  - Codec and profile support (H.264, VP8/VP9)
  - GPU vs CPU transcoding and when each applies
  - Session management for video streams
  - Quality verification (pixel count, PSNR)
  - Pricing: per-pixel model and how to set prices
  - Performance optimisation (concurrent sessions, GPU utilisation)

  SECTION HOME: Guides > Workloads & AI

  JOURNEY POSITION:
  1. Job Types - "What work is available?"
  2. Video Transcoding (this page) - "How does video work?"
  3-6. AI pages...

  CROSS-REFS:
  - Gateway Tab > Node Pipelines > Video Pipelines - gateway side of video
  - Payments & Pricing > Pricing Strategy - setting video prices
  - Monitoring & Tools > Metrics - video transcoding metrics
  - Operator Considerations > Benchmarking - video performance testing
*/}
