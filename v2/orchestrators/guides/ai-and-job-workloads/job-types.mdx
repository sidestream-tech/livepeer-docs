...
See [Run a Pool](/v2/orchestrators/guides/advanced-operations/run-a-pool) and [Fleet Operations](/v2/orchestrators/guides/advanced-operations/large-scale-operations).
</Accordion>
...
{/*
  PURPOSE:
  Journey step: "What types of work can my orchestrator process?"
  Overview of all workload types available on the Livepeer network,
  helping operators understand the full landscape of earning opportunities.

  CONTENT SHOULD INCLUDE:
  - Video transcoding: adaptive bitrate, codec support, segment processing
  - AI inference pipelines: text-to-image, image-to-image, LLM, audio, etc.
  - BYOC (Bring Your Own Container): custom workloads
  - Live AI video: real-time video-to-video processing
  - Comparison: resource requirements, earning potential, demand level
  - Which workloads to prioritise based on hardware

  SECTION HOME: Guides > Workloads & AI

  JOURNEY POSITION:
  1. Job Types (this page) - "What work is available?"
  2. Video Transcoding - "How does video work?"
  3. AI Workloads Guide - "How does AI work?"
  4. Batch AI Setup - "Set up batch AI"
  ...
  - Operator Considerations > Value Proposition - which workloads pay best
  - Gateway Tab > Node Pipelines > Guide - gateway perspective on pipelines
*/}
