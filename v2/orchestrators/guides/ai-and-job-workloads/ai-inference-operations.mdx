...
<BorderedBox variant="accent">
  <AccordionGroup>
    <Accordion title="Already running video?" icon="clapperboard">
      AI pipelines sit beside an existing video orchestrator rather than replacing it. The usual delta is:
      ...
      - expose only the pipelines you can actually keep healthy under load
...
<Note>
  **Low-LPT entry path:** AI inference can be a better starting point than solo video orchestration when stake is limited. Capability, pricing, and latency matter more than active-set position for many AI jobs.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Real-time AI (Cascade)" icon="video" href="/v2/orchestrators/guides/ai-and-job-workloads/realtime-ai-setup">
