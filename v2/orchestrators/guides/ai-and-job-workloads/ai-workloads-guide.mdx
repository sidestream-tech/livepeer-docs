...
<Note>
  **Already running a transcoding orchestrator?** AI pipelines run alongside your existing node using dedicated AI Runner containers. Your transcoding setup does not need to change. See [Batch AI Setup](/v2/orchestrators/guides/workloads-and-ai/batch-ai-setup) for the operator path.
</Note>
...
<CardGroup cols={2}>
  <Card title="Batch AI" icon="layer-group" href="/v2/orchestrators/guides/workloads-and-ai/batch-ai-setup">
  ...
  <Card title="Real-time AI (Cascade)" icon="video" href="/v2/orchestrators/guides/workloads-and-ai/realtime-ai-setup">
...
<StyledTable variant="bordered">
  <TableRow header>
    ...
    <TableCell header>Real-time AI</TableCell>
  </TableRow>
  <TableRow>
...
The LLM pipeline uses a separate runner architecture from the standard `livepeer/ai-runner` image. See [Batch AI Setup](/v2/orchestrators/guides/workloads-and-ai/batch-ai-setup) for the Ollama deployment guide.
...
<Accordion  title="live-video-to-video — Real-time streaming AI (Cascade)" icon="microchip">
...
<StyledTable variant="bordered">
  ...
  <TableRow>
    ...
    <TableCell>24 GB</TableCell>
    <TableCell>RTX 4090, A100</TableCell>
    <TableCell>Real-time latency requirement</TableCell>
  </TableRow>
</StyledTable>

For detailed VRAM planning, warm model strategy, and multi-pipeline configuration, see [Model Hosting and VRAM Planning](/v2/orchestrators/guides/workloads-and-ai/model-vram-reference).
...
<CardGroup cols={2}>
  ...
  <Card title="Batch AI Setup" icon="rocket" href="/v2/orchestrators/guides/workloads-and-ai/batch-ai-setup">
...
{/*
  PURPOSE:
  Journey step: "How does AI inference work on my orchestrator?"
  Comprehensive guide to running AI workloads: pipeline types, model management,
  the AI worker/runner architecture, and operational considerations.

  CONTENT SHOULD INCLUDE:
  - AI worker architecture (go-livepeer + AI runner container)
  - Supported pipelines (text-to-image, image-to-image, LLM, audio, etc.)
  - Model management: downloading, loading, warm vs cold
  - aiModels.json configuration format
  - GPU memory management and model swapping
  - On-chain capability registration (-aiServiceRegistry)
  - AI-specific pricing (-pricePerCapability on orchestrator side)

  SECTION HOME: Guides > Workloads & AI

  JOURNEY POSITION:
  1. Job Types - "What work is available?"
  2. Video Transcoding - "How does video work?"
  3. AI Workloads Guide (this page) - "How does AI work?"
  4. Batch AI Setup - "Set up batch AI"
  5. Realtime AI Setup - "Set up realtime AI"
  6. Model VRAM Reference - "Which models fit my GPU?"

  CROSS-REFS:
  - Gateway Tab > Node Pipelines > AI Pipelines - gateway side of AI routing
  - Workloads & AI > Model VRAM Reference - GPU requirements per model
  - Workloads & AI > Batch AI Setup - practical setup steps
  - Payments & Pricing > Pricing Strategy - setting AI prices
*/}
