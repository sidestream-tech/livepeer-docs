...
{/*
  PURPOSE:
  Tutorial: Running a BYOC CPU pipeline on Livepeer.
  Imported from gateway tutorials - covers custom container deployment.

  NOTE: This tutorial is gateway-focused. Orchestrator operators typically
  want on-chain setup and rewards. Review whether this needs orchestrator-specific
  framing or should remain as-is for cross-reference.

  SECTION HOME: Guides > Tutorials
*/}
