...
See [Configure Pricing](/v2/orchestrators/setup/configure-pricing) for how to adjust your prices.
</Accordion>
...
<CardGroup cols={2}>
  <Card title="Configure Pricing" icon="tag" href="/v2/orchestrators/setup/configure-pricing">
