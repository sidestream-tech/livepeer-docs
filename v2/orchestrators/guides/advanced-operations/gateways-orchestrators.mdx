...
{/*
  PURPOSE:
  "How do gateways find me and how do I get selected for more work?" Discovery:
  on-chain ServiceRegistry, direct -orchAddr, webhook, AI service registry.
  Selection criteria gateways use: price, latency, reliability, capabilities.
  Optimising for selection: competitive pricing, uptime, warm models, fast response.
  Commercial relationships: per-gateway pricing, SLAs. Capability advertisement.

  PLAN TARGET: gateway-relationships (rename for clarity)
  SECTION: Advanced Operations → "How do I scale?"
  JOB STORIES: J4 (gateway relationships)

  CROSS-REFS:
  - Config & Optimisation > Pricing Strategy - pricing affects selection
  - Gateway Tab > Advanced Operations > Orchestrator Selection - gateway side
  - Workloads & AI > AI Inference Operations - capability advertisement
*/}
