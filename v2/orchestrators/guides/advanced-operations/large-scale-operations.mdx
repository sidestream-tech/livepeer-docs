...
<CardGroup cols={2}>
  ...
  <Card title="Split O-T Setup" icon="plug" href="/v2/orchestrators/guides/setup-paths/siphon-setup">
...
{/*
  PURPOSE:
  Journey step: "How do I run orchestrators at enterprise scale?"
  Guide for operators running multiple nodes, multi-GPU setups, or
  fleet deployments across data centres.

  CONTENT SHOULD INCLUDE:
  - Multi-GPU single machine configuration
  - Multi-machine fleet deployment patterns
  - Load balancing across transcoder nodes
  - Centralised monitoring for fleet operations
  - Automation: deployment scripts, config management
  - Cost optimisation at scale
  - When to use O-T split vs multiple solo nodes
  ...
  4. Large-Scale Operations (this page) - "How do I run at scale?"

  CROSS-REFS:
  - Advanced Operations > O-T Setup - split architecture for scaling
  - Deployment Details > Requirements - hardware requirements at scale
  - Monitoring & Tools > Metrics - fleet monitoring
  - Operator Considerations > Value Proposition - economics at scale
*/}
