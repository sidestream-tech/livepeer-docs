...
sidebarTitle: 'Protocol Leadership'
description: >-
...
For the mechanics of staking and delegation, see <LinkArrow href="/v2/orchestrators/guides/staking-and-rewards/governance" label="Governance Guide" newline={false} />. For delegator voting rights, see <LinkArrow href="/v2/orchestrators/guides/staking-and-rewards/attracting-delegates" label="Attracting Delegators" newline={false} />.
...
<CardGroup cols={2}>
  ...
  <Card title="Governance Guide" icon="vote-yea" href="/v2/orchestrators/guides/staking-and-rewards/governance" arrow horizontal>
    How to participate in governance - voting steps, proposal process, and Explorer guide.
  </Card>
  <Card title="Attracting Delegators" icon="users" href="/v2/orchestrators/guides/staking-and-rewards/attracting-delegates" arrow horizontal>
    How to grow delegated stake and build the governance weight that comes with it.
  </Card>
  <Card title="LPT Token Overview" icon="coins" href="/v2/lp-token/overview" arrow horizontal>
