...
If `operator-rationale` answers whether running an Orchestrator can pay, this page answers the next
question: why the role matters even when the financial case is only part of the story.
