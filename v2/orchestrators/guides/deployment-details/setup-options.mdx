...
<StyledTable variant="bordered">
  ...
  <tbody>
    ...
    <TableRow>
      ...
      <TableCell>**O-T split** as the foundation - then see <LinkArrow href="/v2/orchestrators/guides/advanced-operations/run-a-pool" label="Run a Pool" newline={false} /></TableCell>
    </TableRow>
  </tbody>
</StyledTable>
