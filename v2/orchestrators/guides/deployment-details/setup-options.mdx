...
The O-T split separates what the single-process deployment runs together. The Orchestrator process - protocol,
...
<StyledTable variant="bordered">
  ...
  <tbody>
    ...
    <TableRow>
      ...
      <TableCell>**Standard single-process deployment** - see the Setup Guide, not this page</TableCell>
    </TableRow>
    <TableRow>
