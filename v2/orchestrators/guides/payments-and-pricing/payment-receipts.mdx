...
<Tip>
  ETH earnings arrive in discrete redemption steps whenever a winning ticket is redeemed on-chain. A node that processed thousands of jobs may have zero ETH balance changes for hours, then receive a larger deposit. This is expected behaviour and part of the PM design.
</Tip>
