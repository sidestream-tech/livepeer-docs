...
{/*
  PURPOSE:
  Operational payment management. May merge with or complement payment-receipt
  once that page is written. Evaluate scope overlap after payment-receipt content
  exists.
