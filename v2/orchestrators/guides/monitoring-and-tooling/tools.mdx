...
For the full metric reference, see the [Prometheus Metrics Reference](/v2/orchestrators/guides/monitoring-and-troubleshooting/metrics-monitoring).
...
<CardGroup cols={2}>
  <Card title="Livepeer Explorer Guide" icon="compass" href="/v2/orchestrators/guides/monitoring-and-troubleshooting/explorer-guide">
...
{/*
  PURPOSE:
  Journey step: "What tools are available for orchestrator operators?"
  Overview of community and official tools for monitoring, managing,
  and optimising orchestrator operations.

  CONTENT SHOULD INCLUDE:
  - Livepeer Explorer (orchestrator dashboard)
  - tools.livepeer.cloud (network capabilities, pricing)
  - Community tools (Orchestrator Watcher, bots, dashboards)
  - livepeer_cli tool and common operations
  - Prometheus + Grafana setup pointers
  - Third-party monitoring integrations

  SECTION HOME: Guides > Monitoring & Tools

  JOURNEY POSITION:
  1. Tools (this page) - "What tools exist?"
  ...
  CROSS-REFS:
  - Monitoring & Tools > Explorer Guide - detailed Explorer usage
  - Monitoring & Tools > Metrics Monitoring - Prometheus setup
  - Resources > Community Guides - community-built tools
  - Setup > Monitor - basic monitoring from setup
*/}
