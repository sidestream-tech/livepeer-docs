...
See [Model VRAM Reference](/v2/orchestrators/guides/feasibility-and-hardware/hardware-reference#batch-ai-inference) for per-pipeline minimums.
</Accordion>
...
<StyledTable variant="bordered">
  ...
  <TableRow>
    ...
    <TableCell>Install `nvidia-container-toolkit` — see [Hardware Reference](/v2/orchestrators/guides/feasibility-and-hardware/hardware-reference#driver-requirements)</TableCell>
  </TableRow>
  <TableRow>
...
<Accordion  title="ComfyStream container failing (real-time AI)" icon="microchip">
**Checklist:**
...
See [Real-Time AI Setup](/v2/orchestrators/guides/workloads-and-ai/realtime-ai-setup#troubleshooting) for ComfyStream-specific troubleshooting.
</Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Metrics and Monitoring" icon="gauge" href="/v2/orchestrators/guides/monitoring-and-troubleshooting/metrics-monitoring">
    Set up Prometheus to see what is happening inside your node before errors surface.
  </Card>
  <Card title="Explorer Guide" icon="compass" href="/v2/orchestrators/guides/monitoring-and-troubleshooting/explorer-guide">
...
{/*
  PURPOSE:
  Journey step: "How do I debug orchestrator issues?"
  Symptom-based troubleshooting guide for common orchestrator problems:
  no jobs, failed transcoding, reward calling failures, AI errors.

  CONTENT SHOULD INCLUDE:
  - No incoming jobs (selection, connectivity, pricing)
  - Video transcoding failures (GPU errors, codec issues)
  - AI inference failures (model loading, VRAM, container issues)
  - Reward calling failures (gas, timing, ETH balance)
  - Ticket redemption failures
  - Connectivity issues (ports, firewall, NAT)
  - Log interpretation guide
  - Escalation: Discord, Forum, GitHub issues

  SECTION HOME: Guides > Monitoring & Tools

  JOURNEY POSITION:
  1. Tools - "What tools exist?"
  2. Explorer Guide - "How do I use the Explorer?"
  3. Metrics Monitoring - "How do I set up monitoring?"
  4. Troubleshooting (this page) - "How do I debug issues?"

  CROSS-REFS:
  - Resources > FAQ - common questions
  - Monitoring & Tools > Metrics - diagnosing via metrics
  - Setup > Test - verification steps
  - Gateway Tab > Monitoring > Troubleshooting - shared troubleshooting patterns
*/}
