...
You can increase your self-stake directly by bonding more LPT. Attracting delegators requires competitive reward cut and fee share settings and a strong performance track record — see [Getting Delegates](/v2/orchestrators/guides/staking-and-rewards/attracting-delegates).
</Accordion>
...
<Accordion  title="Check if -reward=false is set accidentally" icon="coins">
...
<CardGroup cols={2}>
  ...
  <Card title="Getting Delegates" icon="users" href="/v2/orchestrators/guides/staking-and-rewards/attracting-delegates">
...
{/*
  PURPOSE:
  Journey step: "How do I use the Livepeer Explorer as an orchestrator?"
  Guide for using the Explorer to manage orchestrator profile, view
  performance metrics, track delegators, and monitor earnings.

  CONTENT SHOULD INCLUDE:
  - Orchestrator profile page and what it shows
  - Setting reward cut and fee cut via Explorer
  - Viewing delegator list and stake distribution
  - Performance metrics and scoring
  - Round history and reward calling status
  - Comparing with other orchestrators

  SECTION HOME: Guides > Monitoring & Tools

  JOURNEY POSITION:
  1. Tools - "What tools exist?"
  2. Explorer Guide (this page) - "How do I use the Explorer?"
  3. Metrics Monitoring - "How do I set up monitoring?"
  4. Troubleshooting - "How do I debug issues?"

  CROSS-REFS:
  - Staking & Rewards > Attracting Delegates - Explorer as reputation tool
  - Staking & Rewards > Rewards and Fees - viewing reward history
  - Resources > Community Pools - finding pools via Explorer
*/}
