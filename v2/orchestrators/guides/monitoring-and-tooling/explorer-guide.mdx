...
{/*
  PURPOSE:
  "How do I use Explorer to manage my node day-to-day?" Profile page walkthrough.
  Setting reward/fee cuts. Viewing delegator list and stake distribution. Performance
  metrics and scoring. Round history: identifying missed reward calls. Comparing with
  competitors: price, stake, performance, session count. Explorer as the external
  mirror of node state.

  PLAN TARGET: explorer-operations (consider rename)
  SECTION: Monitoring & Tools → "How do I keep it running?"
  JOB STORIES: J3 (Explorer management), J7 (diagnostic tool)

  CROSS-REFS:
  - Staking & Earning > Growing Delegation - Explorer as reputation tool
  - Staking & Earning > Reward Mechanics - reward history on Explorer
*/}
