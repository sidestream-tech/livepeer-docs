...
go-livepeer exposes metrics across several categories. The full reference is at [Prometheus Metrics Reference](/v2/orchestrators/guides/monitoring-and-tooling/metrics-and-alerting).
...
{/*
  ...
  session saturation above 80%, high error rate, OOM approaching, zero sessions for more than 1 hour.
