...
<StyledTable variant="bordered">
  ...
  <TableRow>
    ...
    <TableCell>Groups performance metrics per stream. Useful for diagnosing individual session issues rather than aggregate counts.</TableCell>
  </TableRow>
  <TableRow>
...
go-livepeer exposes metrics across several categories. The full reference is at [Prometheus Metrics Reference](/v2/orchestrators/guides/monitoring-and-troubleshooting/metrics-monitoring).
...
<CardGroup cols={2}>
  <Card title="Prometheus Metrics Reference" icon="table" href="/v2/orchestrators/guides/monitoring-and-troubleshooting/metrics-monitoring">
  ...
  <Card title="AI Configuration" icon="robot" href="/v2/orchestrators/guides/workloads-and-ai/ai-workloads-guide">
...
{/*
  PURPOSE:
  Journey step: "How do I set up monitoring for my orchestrator?"
  Guide for configuring Prometheus metrics collection, Grafana dashboards,
  and alerting for orchestrator operations.

  CONTENT SHOULD INCLUDE:
  - Enabling metrics (-monitor flag)
  - Key Prometheus metrics for orchestrators
  - Video transcoding metrics (segments, latency, errors)
  - AI inference metrics (requests, latency, model loading)
  - Staking metrics (reward calls, stake changes)
  - Payment metrics (tickets received, redeemed, value)
  - Grafana dashboard setup
  - Alert configuration (missed rewards, high error rates)
  ...
  3. Metrics Monitoring (this page) - "How do I set up monitoring?"
  4. Troubleshooting - "How do I debug issues?"

  CROSS-REFS:
  - Setup > Monitor - basic monitoring from setup flow
  - Gateway Tab > Monitoring > Monitoring Setup - shared Prometheus patterns
  - Resources > Technical > CLI Flags - monitoring-related flags
*/}
