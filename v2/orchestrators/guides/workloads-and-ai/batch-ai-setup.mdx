...
For building and registering custom containers, see [Hosting Models (BYOC)](/v2/orchestrators/guides/advanced-operations/large-scale-operations). {/* REVIEW: confirm path */}
