...
For the full probabilistic micropayment lifecycle, ticket structure, and Redeemer operation, see [Payments](/v2/orchestrators/guides/staking/payments).
