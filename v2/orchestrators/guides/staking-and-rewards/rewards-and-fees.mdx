...
|---|---|
| Gas units per reward call | 350,000 – 450,000 |
| Typical Arbitrum gas price | 0.01 – 0.1 gwei |
| Typical ETH cost per call | ~0.000005 – 0.00005 ETH |
| At ETH = $2,500 | ~$0.01 – $0.12 USD per call |
...
| Strategy | rewardCut | feeShare | Best for |
|---|---|---|---|
| Delegator-attractive | 0–10% | 50–100% | Building stake from zero; maximising delegator ROI |
| Balanced | 15–25% | 20–50% | Mid-stage orchestrators with some delegation |
| Operator-heavy | 50%+ | 0–20% | High self-stake; few delegators needed |
...
| Parameter | Value |
|---|---|
| Network total active stake | 2,000,000 LPT (illustrative) |
| Your stake fraction | 0.5% |
| Inflation rate | 0.05% per round |
| Total supply | 30,000,000 LPT |
| LPT minted per round (before treasury) | 15,000 LPT |
| After 10% treasury | 13,500 LPT distributed |
| Your round allocation | 67.5 LPT |
| You keep (rewardCut 15%) | ~10 LPT |
| Delegators receive | ~57.5 LPT total |
