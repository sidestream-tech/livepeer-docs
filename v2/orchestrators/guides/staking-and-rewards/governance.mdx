...
<CardGroup cols={2}>
  ...
  <Card title="Getting Delegates" icon="people-group" href="/v2/orchestrators/guides/staking-and-rewards/attracting-delegates">
...
{/*
  PURPOSE:
  Journey step: "How do I participate in Livepeer governance?"
  Guide for orchestrators' governance responsibilities: voting on LIPs,
  treasury proposals, and protocol parameter changes.

  CONTENT SHOULD INCLUDE:
  - Orchestrator governance role (vote weight = total stake)
  - LIP (Livepeer Improvement Proposal) voting process
  - Treasury proposal voting
  - Protocol parameter changes
  - Where to follow governance discussions (Forum, Discord)
  - Impact of governance participation on delegator trust
  ...
  3. Attracting Delegates - "How do I grow my stake?"
  4. Governance (this page) - "How do I participate in governance?"

  CROSS-REFS:
  - Delegators Tab > Governance - shared governance mechanics
  - Staking & Rewards > Attracting Delegates - governance as trust signal
