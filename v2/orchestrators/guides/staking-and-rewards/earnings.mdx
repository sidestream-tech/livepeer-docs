...
For the full mechanics of how probabilistic micropayments work, ticket face values, and on-chain redemption, see [Payments](/v2/orchestrators/guides/staking/payments).
...
<CardGroup cols={2}>
  ...
  <Card title="Payments" icon="receipt" href="/v2/orchestrators/guides/staking/payments">
    How ETH moves from gateway to your wallet — probabilistic micropayments, ticket redemption, and the Redeemer.
  </Card>
  <Card title="Governance and Voting" icon="check-to-slot" href="/v2/orchestrators/guides/staking/governance">
