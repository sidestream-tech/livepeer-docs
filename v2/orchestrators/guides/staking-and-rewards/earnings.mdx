...
<StyledTable variant="bordered">
  ...
  <TableRow>
    ...
    <TableCell>Real-time job counts, success rates, ticket values</TableCell>
  </TableRow>
</StyledTable>

Check your reward call history on Explorer regularly. A gap in the reward history means missed rounds and lost LPT. For monitoring setup, see [Metrics and Monitoring](/v2/orchestrators/guides/monitoring-and-troubleshooting/metrics-monitoring).
...
{/*
  PURPOSE:
  Journey step: "How do I earn as an orchestrator?"
  Guide explaining the two earning streams (inflation rewards + service fees),
  how they work, and how to maximise them.

  CONTENT SHOULD INCLUDE:
  - Inflation rewards: LPT minting per round, reward calling
  - Service fees: ETH earned from video and AI jobs
  - Video fees: per-pixel pricing model
  - AI fees: per-capability pricing model
  - Earnings calculation: stake weight, active set, round mechanics
  - Earnings vs costs: when are you profitable?
  - Strategies for maximising earnings (stake, uptime, workload diversity)

  SECTION HOME: Guides > Staking & Rewards

  JOURNEY POSITION:
  1. Earnings (this page) - "How do I earn?"
  ...
  - Operator Considerations > Value Proposition - cost/benefit analysis
  - Payments & Pricing > Payments - payment mechanics
  - Delegators Tab > Delegation Economics - delegator perspective
*/}
