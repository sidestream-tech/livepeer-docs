...
<Warning>
  Missing a round's `Reward()` call means that round's inflation allocation is permanently lost. For a well-staked orchestrator, a single missed round can forfeit a noticeable amount of LPT. Automate this.
</Warning>
