...
**Your response:** This is fully within your control. Automate reward calling, monitor with alerts, keep ETH in your wallet. See [Rewards and Fees](/v2/orchestrators/guides/staking-and-rewards/rewards-and-fees) for the complete setup.
...
{/*
  PURPOSE:
  Journey step: "How do I attract delegators to increase my stake?"
  Guide for orchestrators wanting to grow their delegated stake to improve
  their position in the active set and earn more rewards.

  CONTENT SHOULD INCLUDE:
  - Why delegation matters (active set position, reward share)
  - Setting competitive reward cut and fee cut
  - Building operator reputation (uptime, performance, communication)
  - Operator profile on Livepeer Explorer
  - Community engagement (Discord, Forum, social media)
  - Self-stake signalling (skin in the game)
  - What delegators look for when choosing orchestrators

  SECTION HOME: Guides > Staking & Rewards

  JOURNEY POSITION:
  1. Earnings - "How do I earn?"
  2. Rewards and Fees - "How do rewards and fees work?"
  3. Attracting Delegates (this page) - "How do I grow my stake?"
  4. Governance - "How do I participate in governance?"

  CROSS-REFS:
  - Delegators Tab > Delegation Guide - delegator decision process
  - Monitoring & Tools > Explorer Guide - managing Explorer profile
  - Staking & Rewards > Rewards and Fees - setting competitive cuts
  - Concepts > Incentive Model - delegation economics
*/}
