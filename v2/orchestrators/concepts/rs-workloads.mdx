...
Orchestrators on Livepeer do not just transcode video. They can earn fees from four distinct categories of work, each with different GPU requirements, pricing models, and configuration paths.

This page explains what each job type is, how it reaches your node, and what hardware it demands — so you can decide which to run before choosing a setup path.
