...
<CardGroup cols={3}>
  <Card title="Transcoding Quickstart" icon="film" href="/v2/orchestrators/get-started/quickstart-views/orchestrator-setup" arrow>
 Canonical setup path available now.
  </Card>
  <Card title="Realtime AI Quickstart" icon="bolt" href="/v2/orchestrators/get-started/quickstart-views/realtime-ai-quickstart" arrow>
 Coming soon.
  </Card>
  <Card title="Batch AI Quickstart" icon="boxes-stacked" href="/v2/orchestrators/get-started/quickstart-views/batch-ai-quickstart" arrow>
 Coming soon.
  </Card>
</CardGroup>
