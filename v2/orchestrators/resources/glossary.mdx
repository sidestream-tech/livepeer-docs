...
<StyledTable variant="bordered">
  ...
  <tbody>
    ...
    <TableRow>
      ...
      <TableCell>Solo / Pool worker / Pool operator / O-T split / Siphon</TableCell>
...
<StyledTable variant="bordered">
  ...
  <tbody>
    ...
    <TableRow>
      ...
      <TableCell>A transcoder process connected to an existing pool operator's orchestrator. The pool operator handles on-chain operations (staking, reward calling, ticket redemption). The worker provides GPU compute.</TableCell>
