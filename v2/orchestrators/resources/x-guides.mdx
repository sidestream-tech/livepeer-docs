...
<CardGroup cols={2}>
  <Card
    title="Join a Pool"
    href="/v2/orchestrators/guides/setup-paths/join-a-pool"
    icon="users"
  >
  ...
  <Card
    title="Run a Pool"
    href="/v2/orchestrators/guides/advanced-operations/run-a-pool"
    icon="server"
  >
  ...
  <Card
    title="Staking LPT"
    href="/v2/orchestrators/guides/staking-and-rewards/earnings"
    icon="coins"
  >
  ...
  <Card
    ...
    href="/v2/orchestrators/guides/staking-and-rewards/rewards-and-fees"
    icon="chart-line"
  >
  ...
  <Card
    ...
    href="/v2/orchestrators/guides/monitoring-and-troubleshooting/tools"
    icon="gauge"
  >
...
<CardGroup cols={3}>
  <Card title="Tools" href="/v2/orchestrators/guides/monitoring-and-troubleshooting/tools" />
