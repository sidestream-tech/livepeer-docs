...
<StyledTable variant="bordered">
  ...
  <TableRow>
    <TableCell>[AI Pipeline Overview](/v2/orchestrators/guides/workloads-and-ai/ai-workloads-guide)</TableCell>
...
<StyledTable variant="bordered">
  ...
  <TableRow>
    <TableCell>[Run a Pool](/v2/orchestrators/guides/advanced-operations/run-a-pool)</TableCell>
    <TableCell>Official docs</TableCell>
