...
<StyledTable variant="bordered">
  ...
  <TableRow>
    ...
    <TableCell>`{/* REVIEW: Confirm exact minimum from go-livepeer README or release notes */}`</TableCell>
  </TableRow>
  <TableRow>
    <TableCell>CUDA Toolkit</TableCell>
    <TableCell>12.0+</TableCell>
    <TableCell>`{/* REVIEW: Confirm exact CUDA version from go-livepeer build requirements */}`</TableCell>
  </TableRow>
  <TableRow>
...
For detailed per-pipeline VRAM planning, see the [Models & VRAM Reference](/v2/orchestrators/guides/workloads-and-ai/model-vram-reference).
...
<CardGroup cols={3}>
  ...
  <Card title="Models & VRAM Reference" href="/v2/orchestrators/guides/workloads-and-ai/model-vram-reference" icon="memory" />
  <Card title="Benchmarking" href="/v2/orchestrators/guides/feasibility-and-hardware/benchmarking" icon="gauge-high" />
</CardGroup>
