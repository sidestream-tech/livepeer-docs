...
description: 'How to host AI models on a Livepeer orchestrator node: runtime setup, capability advertisement, pricing, and gateway integration. GPU operator guide.'
keywords: ["livepeer", "orchestrator", "ai models", "comfyui", "comfystream", "byoc", "inference", "gpu", "capability", "pricing"]
...
For a full compatibility matrix by model family, see [Model Support](/v2/developers/ai-pipelines/model-support).
...
<GotoLink
  ...
  relativePath="../quickstart/overview"
/>
...
<CardGroup cols={2}>
  <Card title="BYOC" icon="box" href="/v2/developers/ai-pipelines/byoc">
    Developer guide to building BYOC containers — how to structure your inference server.
  </Card>
  <Card title="Model Support" icon="microchip-ai" href="/v2/developers/ai-pipelines/model-support">
    Full model family compatibility matrix — which models work on Livepeer and why.
  </Card>
  <Card title="ComfyStream" icon="diagram-project" href="/v2/developers/ai-pipelines/comfystream">
    How ComfyStream works as the AI pipeline runtime for orchestrator nodes.
  </Card>
  <Card title="Orchestrator quickstart" icon="rocket" href="../quickstart/overview">
