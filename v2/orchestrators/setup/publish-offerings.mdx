...
description: 'On-chain activation via livepeer_cli — stake LPT, set service URI, and go live.'
sidebarTitle: 'Publish Offerings'
keywords: ["livepeer", "orchestrators", "setting up an orchestrator", "activate", "publish offerings", "marketplace"]
