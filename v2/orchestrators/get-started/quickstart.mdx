...
After [installing go-livepeer](/v2/orchestrators/setup/install-go-livepeer), configure the node so gateways can discover you and send work. This page covers core flags and optional config files.

## Core configuration

### Network and wallet

- **-ethUrl** - Arbitrum RPC URL. See [Connect to Arbitrum](/v2/orchestrators/setup/connect-to-arbitrum).
...
See [AI pipelines](/v2/orchestrators/advanced/ai-pipelines) and [Developers BYOC](/v2/developers/ai-pipelines/byoc) for full AI setup.
