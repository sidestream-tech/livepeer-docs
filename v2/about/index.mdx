...
## X Deprecated
- [⚠️ Livepeer Actors](x-deprecated/actors.mdx)
...
- [⚠️ Technical Roadmap](x-deprecated/technical-roadmap.mdx)

### Livepeer Actors
- [⚠️ Delegators](x-deprecated/livepeer-actors/delegators.mdx)
- [⚠️ End Users](x-deprecated/livepeer-actors/end-users.mdx)
- [⚠️ Gateways](x-deprecated/livepeer-actors/gateways.mdx)
- [⚠️ Orchestrators](x-deprecated/livepeer-actors/orchestrators.mdx)
- [⚠️ README](x-deprecated/livepeer-actors/README.mdx)

### Livepeer Protocol
- [⚠️ Livepeer Whitepaper](x-deprecated/livepeer-protocol/livepeer-whitepaper.mdx)
- [⚠️ Livepeer Protocol](x-deprecated/livepeer-protocol/README.mdx)
