 ...
 * @owner             docs
 * @needs             E-R1, R-R11
 * @purpose-statement Tutorial usefulness prompts — define LLM prompt templates for tutorial page scoring
 * @pipeline          indirect — library module imported by other scripts, not invoked directly
 * @usage             node tools/lib/docs-usefulness/prompts/tutorial.js [flags]
 */
